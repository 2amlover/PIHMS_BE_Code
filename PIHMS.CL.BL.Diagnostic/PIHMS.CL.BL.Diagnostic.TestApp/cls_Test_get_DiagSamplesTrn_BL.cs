...
{
    internal class cls_Test_get_DiagSamplesTrn_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagSamplesTrn_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagSamplesTrn_IP ip = new get_DiagSamplesTrn_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagSamplesTrn_OP op = new get_DiagSamplesTrn_OP();

            //RUN
            bl.get_DiagSamplesTrn(ref ip, ref op);
