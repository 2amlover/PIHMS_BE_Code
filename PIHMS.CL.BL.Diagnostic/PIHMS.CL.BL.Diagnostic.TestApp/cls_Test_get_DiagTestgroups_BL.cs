...
{
    internal class cls_Test_get_DiagTestgroups_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagTestgroups_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagTestgroups_IP ip = new get_DiagTestgroups_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagTestgroups_OP op = new get_DiagTestgroups_OP();

            //RUN
            bl.get_DiagTestgroups(ref ip, ref op);
