...
{
    internal class cls_Test_put_DiagReportStatus_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagReportStatus_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagReportStatus_IP ip = JsonSerializer.Deserialize<put_DiagReportStatus_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagReportStatus_OP op = new put_DiagReportStatus_OP();

            //RUN
            bl.put_DiagReportStatus(ref ip, ref op);
            return Result;
        }
