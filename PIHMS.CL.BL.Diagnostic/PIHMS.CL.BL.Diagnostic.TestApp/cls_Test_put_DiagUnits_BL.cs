...
{
    internal class cls_Test_put_DiagUnits_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagUnits_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagUnits_IP ip = JsonSerializer.Deserialize<put_DiagUnits_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagUnits_OP op = new put_DiagUnits_OP();

            //RUN
            bl.put_DiagUnits(ref ip, ref op);
            return Result;
        }
