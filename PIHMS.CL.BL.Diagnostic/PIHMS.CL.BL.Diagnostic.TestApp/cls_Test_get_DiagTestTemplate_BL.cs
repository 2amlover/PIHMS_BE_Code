...
{
    internal class cls_Test_get_DiagTestTemplate_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagTestTemplate_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagTestTemplate_IP ip = new get_DiagTestTemplate_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagTestTemplate_OP op = new get_DiagTestTemplate_OP();

            //RUN
            bl.get_DiagTestTemplate(ref ip, ref op);
