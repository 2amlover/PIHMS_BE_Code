...
{
    internal class cls_Test_get_DiagReportStatus_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagReportStatus_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagReportStatus_IP ip = new get_DiagReportStatus_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagReportStatus_OP op = new get_DiagReportStatus_OP();

            //RUN
            bl.get_DiagReportStatus(ref ip, ref op);
