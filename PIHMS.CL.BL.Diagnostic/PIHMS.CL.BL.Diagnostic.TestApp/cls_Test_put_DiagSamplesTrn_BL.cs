...
{
    internal class cls_Test_put_DiagSamplesTrn_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagSamplesTrn_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagSamplesTrn_IP ip = JsonSerializer.Deserialize<put_DiagSamplesTrn_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagSamplesTrn_OP op = new put_DiagSamplesTrn_OP();

            //RUN
            bl.put_DiagSamplesTrn(ref ip, ref op);
            return Result;
        }
