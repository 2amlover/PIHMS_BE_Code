...
{
    internal class cls_Test_get_DiagSamplesMas_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagSamplesMas_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagSamplesMas_IP ip = new get_DiagSamplesMas_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagSamplesMas_OP op = new get_DiagSamplesMas_OP();

            //RUN
            bl.get_DiagSamplesMas(ref ip, ref op);
