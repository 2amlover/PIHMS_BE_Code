...
{
    internal class cls_Test_get_DiagTestinstrumentationName_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagTestinstrumentationName_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
           ...
           get_DiagTestinstrumentationName_IP ip = new get_DiagTestinstrumentationName_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

           get_DiagTestinstrumentationName_OP op = new get_DiagTestinstrumentationName_OP();

            //RUN
            bl.get_DiagTestinstrumentationName(ref ip, ref op);
