...
{
    internal class cls_Test_get_DiagTestranges_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagTestranges_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagTestranges_IP ip = new get_DiagTestranges_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagTestranges_OP op = new get_DiagTestranges_OP();

            //RUN
            bl.get_DiagTestranges(ref ip, ref op);
