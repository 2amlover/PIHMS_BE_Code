...
{
    internal class cls_Test_get_DiagUnits_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagUnits_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagUnits_IP ip = new get_DiagUnits_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagUnits_OP op = new get_DiagUnits_OP();

            //RUN
            bl.get_DiagUnits(ref ip, ref op);
