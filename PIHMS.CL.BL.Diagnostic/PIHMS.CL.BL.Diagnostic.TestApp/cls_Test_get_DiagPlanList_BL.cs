...
{
    internal class cls_Test_get_DiagPlanList_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagPlanList_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagPlanList_IP ip = new get_DiagPlanList_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagPlanList_OP op = new get_DiagPlanList_OP();

            //RUN
            bl.get_DiagPlanList(ref ip, ref op);
