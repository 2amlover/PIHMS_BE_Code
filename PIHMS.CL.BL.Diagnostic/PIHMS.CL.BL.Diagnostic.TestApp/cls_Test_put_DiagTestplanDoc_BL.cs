...
{
    internal class cls_Test_put_DiagTestplanDoc_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagTestplanDoc_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagTestplanDoc_IP ip = JsonSerializer.Deserialize<put_DiagTestplanDoc_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagTestplanDoc_OP op = new put_DiagTestplanDoc_OP();

            //RUN
            bl.put_DiagTestplanDoc(ref ip, ref op);
            return Result;
        }
