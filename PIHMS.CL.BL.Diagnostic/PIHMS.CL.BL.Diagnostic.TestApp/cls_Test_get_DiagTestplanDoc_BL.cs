...
{
    internal class cls_Test_get_DiagTestplanDoc_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagTestplanDoc_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagTestplanDoc_IP ip = new get_DiagTestplanDoc_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagTestplanDoc_OP op = new get_DiagTestplanDoc_OP();

            //RUN
            bl.get_DiagTestplanDoc(ref ip, ref op);
