...
{
    internal class cls_Test_get_DiagReport_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagReport_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagReport_IP ip = new get_DiagReport_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagReport_OP op = new get_DiagReport_OP();

            //RUN
            bl.get_DiagReport(ref ip, ref op);
