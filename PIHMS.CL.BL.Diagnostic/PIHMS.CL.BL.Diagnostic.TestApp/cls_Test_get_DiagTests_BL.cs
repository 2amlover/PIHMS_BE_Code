...
{
    internal class cls_Test_get_DiagTests_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagTests_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagTests_IP ip = new get_DiagTests_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagTests_OP op = new get_DiagTests_OP();

            //RUN
            bl.get_DiagTests(ref ip, ref op);
