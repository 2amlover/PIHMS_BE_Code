...
{
    internal class cls_Test_put_DiagSamplesMas_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagSamplesMas_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagSamplesMas_IP ip = JsonSerializer.Deserialize<put_DiagSamplesMas_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagSamplesMas_OP op = new put_DiagSamplesMas_OP();

            //RUN
            bl.put_DiagSamplesMas(ref ip, ref op);
            return Result;
        }
