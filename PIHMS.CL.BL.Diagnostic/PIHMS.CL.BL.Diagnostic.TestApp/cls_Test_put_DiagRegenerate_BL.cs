...
{
    internal class cls_Test_put_DiagRegenerate_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagRegenerate_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagRegenerate_IP ip = JsonSerializer.Deserialize<put_DiagRegenerate_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagRegenerate_OP op = new put_DiagRegenerate_OP();
            //RUN
            bl.put_DiagRegenerate(ref ip, ref op);
            return Result;
        }
