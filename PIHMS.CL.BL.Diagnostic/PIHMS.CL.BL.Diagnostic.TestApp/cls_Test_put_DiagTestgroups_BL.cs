...
{
    internal class cls_Test_put_DiagTestgroups_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagTestgroups_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagTestgroups_IP ip = JsonSerializer.Deserialize<put_DiagTestgroups_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagTestgroups_OP op = new put_DiagTestgroups_OP();

            //RUN
            bl.put_DiagTestgroups(ref ip, ref op);
            return Result;
        }
