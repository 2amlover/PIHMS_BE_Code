...
{
    internal class cls_Test_get_ScanUsreport_BL
    {
        String m_DBConnStr;
        public cls_Test_get_ScanUsreport_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_ScanUsreport_IP ip = new get_ScanUsreport_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_ScanUsreport_OP op = new get_ScanUsreport_OP();

            //RUN
            bl.get_ScanUsreport(ref ip, ref op);
