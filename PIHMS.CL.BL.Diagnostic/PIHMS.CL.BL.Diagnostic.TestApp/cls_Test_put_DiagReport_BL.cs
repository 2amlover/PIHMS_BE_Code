...
{
    internal class cls_Test_put_DiagReport_BL
    {
        String m_DBConnStr;
        public cls_Test_put_DiagReport_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_DiagReport_IP ip = JsonSerializer.Deserialize<put_DiagReport_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_DiagReport_OP op = new put_DiagReport_OP();

            //RUN
            bl.put_DiagReport(ref ip, ref op);
            return Result;
        }
