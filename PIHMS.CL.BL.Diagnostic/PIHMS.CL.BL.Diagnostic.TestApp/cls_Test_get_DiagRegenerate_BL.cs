...
{
    internal class cls_Test_get_DiagRegenerate_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DiagRegenerate_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DiagRegenerate_IP ip = new get_DiagRegenerate_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DiagRegenerate_OP op = new get_DiagRegenerate_OP();

            //RUN
            bl.get_DiagRegenerate(ref ip, ref op);
