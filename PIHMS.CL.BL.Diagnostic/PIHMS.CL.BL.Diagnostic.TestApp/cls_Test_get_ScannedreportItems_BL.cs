...
{
    internal class cls_Test_get_ScannedreportItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_ScannedreportItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_ScannedreportItems_IP ip = new get_ScannedreportItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_ScannedreportItems_OP op = new get_ScannedreportItems_OP();

            //RUN
            bl.get_ScannedreportItems(ref ip, ref op);
