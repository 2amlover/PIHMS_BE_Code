...
{
    class put_DiagTests_BL : cls_BC_BusinessLogic
    {
        public put_DiagTests_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_DiagTests(ref put_DiagTests_IP ipdc, ref put_DiagTests_OP opdc)
        {
            ...
            if (ipdc.m_Diag.ID > 0)
            {
                ...
                m_rc = put_DiagTests_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_DiagTests_Insert(ref ipdc, ref opdc);
        ...
        private int put_DiagTests_Insert(ref put_DiagTests_IP ipdc, ref put_DiagTests_OP opdc)
        {
            List<tbl_mas_diag_tests> m_DiagTemp = new List<tbl_mas_diag_tests>();
        ...
        private int put_DiagTests_Update(ref put_DiagTests_IP ipdc, ref put_DiagTests_OP opdc)
        {
