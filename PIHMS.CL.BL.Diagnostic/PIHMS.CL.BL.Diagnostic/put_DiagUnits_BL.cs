...
{
    class put_DiagUnits_BL : cls_BC_BusinessLogic
    {
        public put_DiagUnits_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_DiagUnits(ref put_DiagUnits_IP ipdc, ref put_DiagUnits_OP opdc)
        {
            ...
            if (ipdc.m_Diag.ID > 0)
            {
                ...
                m_rc = put_DiagUnits_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_DiagUnits_Insert(ref ipdc, ref opdc);
        ...
        private int put_DiagUnits_Insert(ref put_DiagUnits_IP ipdc, ref put_DiagUnits_OP opdc)
        {
            List<tbl_mas_diag_units> m_DiagTemp = new List<tbl_mas_diag_units>();
        ...
        private int put_DiagUnits_Update(ref put_DiagUnits_IP ipdc, ref put_DiagUnits_OP opdc)
        {
