...
{
    class get_PatientInsuranceList_BL : cls_BC_BusinessLogic
    {
        public get_PatientInsuranceList_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int get_PatientInsuranceList(ref get_PatientInsuranceList_IP ip, ref get_PatientInsuranceList_OP op)
        {
            ...
            op.ml_PatientInsurance = m_PatientTemp;
            return m_rc;
        }
