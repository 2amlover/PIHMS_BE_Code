...
{
    internal class cls_Test_get_PatientHistoryScannedFiles_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PatientHistoryScannedFiles_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PatientHistoryScannedFiles_IP ip = new get_PatientHistoryScannedFiles_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";
            get_PatientHistoryScannedFiles_OP op = new get_PatientHistoryScannedFiles_OP();

            //RUN
            bl.get_PatientHistoryScannedFiles(ref ip, ref op);
