...
{
    internal class cls_Test_get_PatientBirthDetails_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PatientBirthDetails_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PatientBirthDetails_IP ip = new get_PatientBirthDetails_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PatientBirthDetails_OP op = new get_PatientBirthDetails_OP();

            //RUN
            bl.get_PatientBirthDetails(ref ip, ref op);
