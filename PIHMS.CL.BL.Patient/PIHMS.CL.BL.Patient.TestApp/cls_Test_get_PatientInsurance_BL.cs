...
{
    internal class cls_Test_get_PatientInsurance_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PatientInsurance_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PatientInsurance_IP ip = new get_PatientInsurance_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PatientInsurance_OP op = new get_PatientInsurance_OP();

            //RUN
            bl.get_PatientInsurance(ref ip, ref op);
