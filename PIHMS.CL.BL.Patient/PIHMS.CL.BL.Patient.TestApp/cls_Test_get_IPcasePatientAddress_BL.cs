...
{
    internal class cls_Test_get_IPcasePatientAddress_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPcasePatientAddress_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPcasePatientAddress_IP ip = new get_IPcasePatientAddress_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPcasePatientAddress_OP op = new get_IPcasePatientAddress_OP();

            //RUN
            bl.get_IPcasePatientAddress(ref ip, ref op);
