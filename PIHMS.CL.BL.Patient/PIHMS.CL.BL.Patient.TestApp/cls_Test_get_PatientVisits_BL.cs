...
{
    internal class cls_Test_get_PatientVisits_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PatientVisits_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PatientVisits_IP ip = new get_PatientVisits_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PatientVisits_OP op = new get_PatientVisits_OP();

            //RUN
            bl.get_PatientVisits(ref ip, ref op);
