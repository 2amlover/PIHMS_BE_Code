...
{
    internal class cls_Test_get_PatientList_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PatientList_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PatientList_IP ip = new get_PatientList_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_FilterOptions.m_Limit = "10";

            get_PatientList_OP op = new get_PatientList_OP();

            //RUN
            bl.get_PatientList(ref ip, ref op);
