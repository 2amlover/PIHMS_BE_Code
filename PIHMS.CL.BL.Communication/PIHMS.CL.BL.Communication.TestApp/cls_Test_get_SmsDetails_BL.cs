...
{
    internal class cls_Test_get_SmsDetails_BL
    {
        String m_DBConnStr;
        public cls_Test_get_SmsDetails_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_SmsDetails_IP ip = new get_SmsDetails_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_SmsDetails_OP op = new get_SmsDetails_OP();

            //RUN
            bl.get_SmsDetails(ref ip, ref op);
