...
{
    internal class cls_Test_get_DashboardMessage_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DashboardMessage_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DashboardMessage_IP ip = new get_DashboardMessage_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DashboardMessage_OP op = new get_DashboardMessage_OP();

            //RUN
            bl.get_DashboardMessage(ref ip, ref op);
