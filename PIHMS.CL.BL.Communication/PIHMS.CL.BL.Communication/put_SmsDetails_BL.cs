...
{
    class put_SmsDetails_BL : cls_BC_BusinessLogic
    {
        public put_SmsDetails_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }


        public int put_SmsDetails(ref put_SmsDetails_IP ipdc, ref put_SmsDetails_OP opdc)
        {
            ...
            if (ipdc.m_Communication.ID > 0)
            {
                ...
                m_rc = put_SmsDetails_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_SmsDetails_Insert(ref ipdc, ref opdc);
        ...
        private int put_SmsDetails_Insert(ref put_SmsDetails_IP ipdc, ref put_SmsDetails_OP opdc)
        {
            List<tbl_trn_sms_details> m_CommunicationTemp = new List<tbl_trn_sms_details>();
        ...
        private int put_SmsDetails_Update(ref put_SmsDetails_IP ipdc, ref put_SmsDetails_OP opdc)
        {
