...
{
    class put_IPWardschedule_BL : cls_BC_BusinessLogic
    {
        public put_IPWardschedule_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_IPWardschedule(ref put_IPWardschedule_IP ipdc, ref put_IPWardschedule_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPWardschedule_IP ipdc, ref put_IPWardschedule_OP opdc)
        {
            List<tbl_trn_wardschedule> m_InPatientTemp = new List<tbl_trn_wardschedule>();
        ...
        private int put_InPatient_Update(ref put_IPWardschedule_IP ipdc, ref put_IPWardschedule_OP opdc)
        {
