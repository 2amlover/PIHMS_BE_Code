...
{
    class put_IPCaseBillSummary_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseBillSummary_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseBillSummary(ref put_IPCaseBillSummary_IP ipdc, ref put_IPCaseBillSummary_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseBillSummary_IP ipdc, ref put_IPCaseBillSummary_OP opdc)
        {
            List<tbl_trn_ipcase_billsummary> m_InPatientTemp = new List<tbl_trn_ipcase_billsummary>();
        ...
        private int put_InPatient_Update(ref put_IPCaseBillSummary_IP ipdc, ref put_IPCaseBillSummary_OP opdc)
        {
