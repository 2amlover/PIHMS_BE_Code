...
{
    class put_IPCaseBillPayments_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseBillPayments_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseBillPayments(ref put_IPCaseBillPayments_IP ipdc, ref put_IPCaseBillPayments_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseBillPayments_IP ipdc, ref put_IPCaseBillPayments_OP opdc)
        {
            List<tbl_trn_ipcase_billpayments> m_InPatientTemp = new List<tbl_trn_ipcase_billpayments>();
        ...
        private int put_InPatient_Update(ref put_IPCaseBillPayments_IP ipdc, ref put_IPCaseBillPayments_OP opdc)
        {
