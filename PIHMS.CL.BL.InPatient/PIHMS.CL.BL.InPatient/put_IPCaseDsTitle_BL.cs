...
{
    class put_IPCaseDsTitle_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseDsTitle_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseDsTitle(ref put_IPCaseDsTitle_IP ipdc, ref put_IPCaseDsTitle_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseDsTitle_IP ipdc, ref put_IPCaseDsTitle_OP opdc)
        {
            List<tbl_mas_ipcase_dstitle> m_InPatientTemp = new List<tbl_mas_ipcase_dstitle>();
        ...
        private int put_InPatient_Update(ref put_IPCaseDsTitle_IP ipdc, ref put_IPCaseDsTitle_OP opdc)
        {
