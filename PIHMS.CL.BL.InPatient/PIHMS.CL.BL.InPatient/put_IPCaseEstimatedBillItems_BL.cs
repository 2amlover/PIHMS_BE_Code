...
{
    class put_IPCaseEstimatedBillItems_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseEstimatedBillItems_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        
        public int put_IPCaseEstimatedBillItems(ref put_IPCaseEstimatedBillItems_IP ipdc, ref put_IPCaseEstimatedBillItems_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseEstimatedBillItems_IP ipdc, ref put_IPCaseEstimatedBillItems_OP opdc)
        {
            List<tbl_trn_ipcase_estimatedbillitems> m_InPatientTemp = new List<tbl_trn_ipcase_estimatedbillitems>();
        ...
        private int put_InPatient_Update(ref put_IPCaseEstimatedBillItems_IP ipdc, ref put_IPCaseEstimatedBillItems_OP opdc)
        {
