...
{
    class put_IPCaseEstimatedBills_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseEstimatedBills_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        
        public int put_IPCaseEstimatedBills(ref put_IPCaseEstimatedBills_IP ipdc, ref put_IPCaseEstimatedBills_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseEstimatedBills_IP ipdc, ref put_IPCaseEstimatedBills_OP opdc)
        {
            List<tbl_trn_ipcase_estimatedbills> m_InPatientTemp = new List<tbl_trn_ipcase_estimatedbills>();
        ...
        private int put_InPatient_Update(ref put_IPCaseEstimatedBills_IP ipdc, ref put_IPCaseEstimatedBills_OP opdc)
        {
