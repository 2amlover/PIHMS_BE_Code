...
{
    class put_IPCaseMedications_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseMedications_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseMedications(ref put_IPCaseMedications_IP ipdc, ref put_IPCaseMedications_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseMedications_IP ipdc, ref put_IPCaseMedications_OP opdc)
        {
            List<tbl_trn_ipcase_medications> m_InPatientTemp = new List<tbl_trn_ipcase_medications>();
        ...
        private int put_InPatient_Update(ref put_IPCaseMedications_IP ipdc, ref put_IPCaseMedications_OP opdc)
        {
