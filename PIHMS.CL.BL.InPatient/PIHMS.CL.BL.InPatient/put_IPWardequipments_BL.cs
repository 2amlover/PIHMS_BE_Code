...
{
    class put_IPWardequipments_BL : cls_BC_BusinessLogic
    {
        public put_IPWardequipments_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_IPWardequipments(ref put_IPWardequipments_IP ipdc, ref put_IPWardequipments_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPWardequipments_IP ipdc, ref put_IPWardequipments_OP opdc)
        {
            List<tbl_trn_wardequipments> m_InPatientTemp = new List<tbl_trn_wardequipments>();
        ...
        private int put_InPatient_Update(ref put_IPWardequipments_IP ipdc, ref put_IPWardequipments_OP opdc)
        {
