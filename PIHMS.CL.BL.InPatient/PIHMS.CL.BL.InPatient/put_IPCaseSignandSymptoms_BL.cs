...
{
    class put_IPCaseSignandSymptoms_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseSignandSymptoms_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseSignandSymptoms(ref put_IPCaseSignandSymptoms_IP ipdc, ref put_IPCaseSignandSymptoms_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseSignandSymptoms_IP ipdc, ref put_IPCaseSignandSymptoms_OP opdc)
        {
            List<tbl_trn_ipcase_signandsymptoms> m_InPatientTemp = new List<tbl_trn_ipcase_signandsymptoms>();
        ...
        private int put_InPatient_Update(ref put_IPCaseSignandSymptoms_IP ipdc, ref put_IPCaseSignandSymptoms_OP opdc)
        {
