...
{
    class put_IPCaseBills_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseBills_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseBills(ref put_IPCaseBills_IP ipdc, ref put_IPCaseBills_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseBills_IP ipdc, ref put_IPCaseBills_OP opdc)
        {
            List<tbl_trn_ipcase_bills> m_InPatientTemp = new List<tbl_trn_ipcase_bills>();
        ...
        private int put_InPatient_Update(ref put_IPCaseBills_IP ipdc, ref put_IPCaseBills_OP opdc)
        {
