...
{
    class put_IPCaseAdmittedFor_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseAdmittedFor_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_IPCaseAdmittedFor(ref put_IPCaseAdmittedFor_IP ipdc, ref put_IPCaseAdmittedFor_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseAdmittedFor_IP ipdc, ref put_IPCaseAdmittedFor_OP opdc)
        {
            List<tbl_mas_ipcase_admittedfor> m_InPatientTemp = new List<tbl_mas_ipcase_admittedfor>();
        ...
        private int put_InPatient_Update(ref put_IPCaseAdmittedFor_IP ipdc, ref put_IPCaseAdmittedFor_OP opdc)
        {
