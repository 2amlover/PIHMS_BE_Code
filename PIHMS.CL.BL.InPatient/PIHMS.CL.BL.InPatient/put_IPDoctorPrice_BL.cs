...
{
    class put_IPDoctorPrice_BL : cls_BC_BusinessLogic
    {
        public put_IPDoctorPrice_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_IPDoctorPrice(ref put_IPDoctorPrice_IP ipdc, ref put_IPDoctorPrice_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPDoctorPrice_IP ipdc, ref put_IPDoctorPrice_OP opdc)
        {
            List<tbl_trn_ip_doctor_price> m_InPatientTemp = new List<tbl_trn_ip_doctor_price>();
        ...
        private int put_InPatient_Update(ref put_IPDoctorPrice_IP ipdc, ref put_IPDoctorPrice_OP opdc)
        {
