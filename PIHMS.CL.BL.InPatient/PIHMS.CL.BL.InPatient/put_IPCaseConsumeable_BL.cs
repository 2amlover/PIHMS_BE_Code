...
{
    class put_IPCaseConsumeable_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseConsumeable_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseConsumeable(ref put_IPCaseConsumeable_IP ipdc, ref put_IPCaseConsumeable_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseConsumeable_IP ipdc, ref put_IPCaseConsumeable_OP opdc)
        {
            List<tbl_trn_ipcase_consumeable> m_InPatientTemp = new List<tbl_trn_ipcase_consumeable>();
        ...
        private int put_InPatient_Update(ref put_IPCaseConsumeable_IP ipdc, ref put_IPCaseConsumeable_OP opdc)
        {
