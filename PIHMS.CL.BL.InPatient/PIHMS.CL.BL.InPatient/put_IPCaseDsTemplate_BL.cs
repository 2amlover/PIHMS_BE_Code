...
{
    class put_IPCaseDsTemplate_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseDsTemplate_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseDsTemplate(ref put_IPCaseDsTemplate_IP ipdc, ref put_IPCaseDsTemplate_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseDsTemplate_IP ipdc, ref put_IPCaseDsTemplate_OP opdc)
        {
            List<tbl_mas_ipcase_dstemplate> m_InPatientTemp = new List<tbl_mas_ipcase_dstemplate>();
        ...
        private int put_InPatient_Update(ref put_IPCaseDsTemplate_IP ipdc, ref put_IPCaseDsTemplate_OP opdc)
        {
