...
{
    class put_IPCaseInsurenceReceived_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseInsurenceReceived_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseInsurenceReceived(ref put_IPCaseInsurenceReceived_IP ipdc, ref put_IPCaseInsurenceReceived_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseInsurenceReceived_IP ipdc, ref put_IPCaseInsurenceReceived_OP opdc)
        {
            List<tbl_trn_ipcase_insurencereceived> m_InPatientTemp = new List<tbl_trn_ipcase_insurencereceived>();
        ...
        private int put_InPatient_Update(ref put_IPCaseInsurenceReceived_IP ipdc, ref put_IPCaseInsurenceReceived_OP opdc)
        {
