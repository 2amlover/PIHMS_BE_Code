...
{
    class put_IPCaseInsuranceDetail_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseInsuranceDetail_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        
        public int put_IPCaseInsuranceDetail(ref put_IPCaseInsuranceDetail_IP ipdc, ref put_IPCaseInsuranceDetail_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseInsuranceDetail_IP ipdc, ref put_IPCaseInsuranceDetail_OP opdc)
        {
            List<tbl_trn_ipcase_insurancedetail> m_InPatientTemp = new List<tbl_trn_ipcase_insurancedetail>();
        ...
        private int put_InPatient_Update(ref put_IPCaseInsuranceDetail_IP ipdc, ref put_IPCaseInsuranceDetail_OP opdc)
        {
