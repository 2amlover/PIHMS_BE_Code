...
{
    class put_IPWardincharge_BL : cls_BC_BusinessLogic
    {
        public put_IPWardincharge_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_IPWardincharge(ref put_IPWardincharge_IP ipdc, ref put_IPWardincharge_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPWardincharge_IP ipdc, ref put_IPWardincharge_OP opdc)
        {
            List<tbl_trn_wardincharge> m_InPatientTemp = new List<tbl_trn_wardincharge>();
        ...
        private int put_InPatient_Update(ref put_IPWardincharge_IP ipdc, ref put_IPWardincharge_OP opdc)
        {
