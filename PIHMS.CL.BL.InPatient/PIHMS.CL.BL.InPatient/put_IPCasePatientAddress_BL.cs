...
namespace PIHMS.CL.BL.InPatient
{
    class put_IPCasePatientAddress_BL : cls_BC_BusinessLogic
    {
        ...
        private int put_InPatient_Insert(ref put_IPCasePatientAddress_IP ipdc, ref put_IPCasePatientAddress_OP opdc)
        {
            List<tbl_trn_ipcase_patient_address> m_InPatientTemp = new List<tbl_trn_ipcase_patient_address>();
        ...
        private int put_InPatient_Update(ref put_IPCasePatientAddress_IP ipdc, ref put_IPCasePatientAddress_OP opdc)
        {
