...
{
    class put_IPCaseDischargeSummary_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseDischargeSummary_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseDischargeSummary(ref put_IPCaseDischargeSummary_IP ipdc, ref put_IPCaseDischargeSummary_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseDischargeSummary_IP ipdc, ref put_IPCaseDischargeSummary_OP opdc)
        {
            List<tbl_trn_ipcase_dischargesummary> m_InPatientTemp = new List<tbl_trn_ipcase_dischargesummary>();
        ...
        private int put_InPatient_Update(ref put_IPCaseDischargeSummary_IP ipdc, ref put_IPCaseDischargeSummary_OP opdc)
        {
