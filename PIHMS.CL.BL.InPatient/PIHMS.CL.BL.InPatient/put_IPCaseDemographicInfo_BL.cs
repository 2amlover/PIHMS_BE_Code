...
{
    class put_IPCaseDemographicInfo_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseDemographicInfo_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseDemographicInfo(ref put_IPCaseDemographicInfo_IP ipdc, ref put_IPCaseDemographicInfo_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseDemographicInfo_IP ipdc, ref put_IPCaseDemographicInfo_OP opdc)
        {
            List<tbl_trn_ipcase_demographicinfo> m_InPatientTemp = new List<tbl_trn_ipcase_demographicinfo>();
        ...
        private int put_InPatient_Update(ref put_IPCaseDemographicInfo_IP ipdc, ref put_IPCaseDemographicInfo_OP opdc)
        {
