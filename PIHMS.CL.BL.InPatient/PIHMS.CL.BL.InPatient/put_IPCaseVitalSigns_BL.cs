...
{
    class put_IPCaseVitalSigns_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseVitalSigns_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseVitalSigns(ref put_IPCaseVitalSigns_IP ipdc, ref put_IPCaseVitalSigns_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseVitalSigns_IP ipdc, ref put_IPCaseVitalSigns_OP opdc)
        {
            List<tbl_trn_ipcase_vitalsigns> m_InPatientTemp = new List<tbl_trn_ipcase_vitalsigns>();
        ...
        private int put_InPatient_Update(ref put_IPCaseVitalSigns_IP ipdc, ref put_IPCaseVitalSigns_OP opdc)
        {
