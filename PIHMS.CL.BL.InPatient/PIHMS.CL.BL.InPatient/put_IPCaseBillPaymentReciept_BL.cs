...
{
    class put_IPCaseBillPaymentReciept_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseBillPaymentReciept_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }


        public int put_IPCaseBillPaymentReciept(ref put_IPCaseBillPaymentReciept_IP ipdc, ref put_IPCaseBillPaymentReciept_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseBillPaymentReciept_IP ipdc, ref put_IPCaseBillPaymentReciept_OP opdc)
        {
            List<tbl_trn_ipcase_billpaymentreciept> m_InPatientTemp = new List<tbl_trn_ipcase_billpaymentreciept>();
        ...
        private int put_InPatient_Update(ref put_IPCaseBillPaymentReciept_IP ipdc, ref put_IPCaseBillPaymentReciept_OP opdc)
        {
