...
{
    class put_IPCaseInsurencePayment_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseInsurencePayment_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseInsurencePayment(ref put_IPCaseInsurencePayment_IP ipdc, ref put_IPCaseInsurencePayment_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseInsurencePayment_IP ipdc, ref put_IPCaseInsurencePayment_OP opdc)
        {
            List<tbl_trn_ipcase_insurencepayment> m_InPatientTemp = new List<tbl_trn_ipcase_insurencepayment>();
        ...
        private int put_InPatient_Update(ref put_IPCaseInsurencePayment_IP ipdc, ref put_IPCaseInsurencePayment_OP opdc)
        {
