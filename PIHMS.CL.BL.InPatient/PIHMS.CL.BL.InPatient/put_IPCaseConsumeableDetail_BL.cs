...
{
    class put_IPCaseConsumeableDetail_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseConsumeableDetail_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseConsumeableDetail(ref put_IPCaseConsumeableDetail_IP ipdc, ref put_IPCaseConsumeableDetail_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseConsumeableDetail_IP ipdc, ref put_IPCaseConsumeableDetail_OP opdc)
        {
            List<tbl_trn_ipcase_consumeable_detail> m_InPatientTemp = new List<tbl_trn_ipcase_consumeable_detail>();
        ...
        private int put_InPatient_Update(ref put_IPCaseConsumeableDetail_IP ipdc, ref put_IPCaseConsumeableDetail_OP opdc)
        {
