...
{
    class put_IPCaseSurgeryNotes_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseSurgeryNotes_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseSurgeryNotes(ref put_IPCaseSurgeryNotes_IP ipdc, ref put_IPCaseSurgeryNotes_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseSurgeryNotes_IP ipdc, ref put_IPCaseSurgeryNotes_OP opdc)
        {
            List<tbl_trn_ipcase_surgerynotes> m_InPatientTemp = new List<tbl_trn_ipcase_surgerynotes>();
        ...
        private int put_InPatient_Update(ref put_IPCaseSurgeryNotes_IP ipdc, ref put_IPCaseSurgeryNotes_OP opdc)
        {
