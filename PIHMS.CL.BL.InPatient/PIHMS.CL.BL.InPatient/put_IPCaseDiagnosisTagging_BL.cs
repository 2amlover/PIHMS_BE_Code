...
namespace PIHMS.CL.BL.InPatient
{
    class put_IPCaseDiagnosisTagging_BL : cls_BC_BusinessLogic
    {
        ...
        private int put_InPatient_Insert(ref put_IPCaseDiagnosisTagging_IP ipdc, ref put_IPCaseDiagnosisTagging_OP opdc)
        {
            List<tbl_trn_ipcase_diagnosis_tagging> m_InPatientTemp = new List<tbl_trn_ipcase_diagnosis_tagging>();
        ...
        private int put_InPatient_Update(ref put_IPCaseDiagnosisTagging_IP ipdc, ref put_IPCaseDiagnosisTagging_OP opdc)
        {
