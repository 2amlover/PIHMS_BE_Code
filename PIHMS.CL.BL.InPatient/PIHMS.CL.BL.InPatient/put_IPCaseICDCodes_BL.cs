...
{
    class put_IPCaseICDCodes_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseICDCodes_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseICDCodes(ref put_IPCaseICDCodes_IP ipdc, ref put_IPCaseICDCodes_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseICDCodes_IP ipdc, ref put_IPCaseICDCodes_OP opdc)
        {
            List<tbl_trn_ipcase_icdcodes> m_InPatientTemp = new List<tbl_trn_ipcase_icdcodes>();
        ...
        private int put_InPatient_Update(ref put_IPCaseICDCodes_IP ipdc, ref put_IPCaseICDCodes_OP opdc)
        {
