...
{
    class put_IPCaseDoctors_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseDoctors_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseDoctors(ref put_IPCaseDoctors_IP ipdc, ref put_IPCaseDoctors_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseDoctors_IP ipdc, ref put_IPCaseDoctors_OP opdc)
        {
            List<tbl_trn_ipcase_doctors> m_InPatientTemp = new List<tbl_trn_ipcase_doctors>();
        ...
        private int put_InPatient_Update(ref put_IPCaseDoctors_IP ipdc, ref put_IPCaseDoctors_OP opdc)
        {
