...
{
    class put_IPCaseDsTemplateData_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseDsTemplateData_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseDsTemplateData(ref put_IPCaseDsTemplateData_IP ipdc, ref put_IPCaseDsTemplateData_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseDsTemplateData_IP ipdc, ref put_IPCaseDsTemplateData_OP opdc)
        {
            List<tbl_mas_ipcase_dstemplate_data> m_InPatientTemp = new List<tbl_mas_ipcase_dstemplate_data>();
        ...
        private int put_InPatient_Update(ref put_IPCaseDsTemplateData_IP ipdc, ref put_IPCaseDsTemplateData_OP opdc)
        {
