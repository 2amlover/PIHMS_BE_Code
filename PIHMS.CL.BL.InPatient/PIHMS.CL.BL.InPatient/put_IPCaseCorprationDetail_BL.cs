...
{
    class put_IPCaseCorprationDetail_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseCorprationDetail_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        
        public int put_IPCaseCorprationDetail(ref put_IPCaseCorprationDetail_IP ipdc, ref put_IPCaseCorprationDetail_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseCorprationDetail_IP ipdc, ref put_IPCaseCorprationDetail_OP opdc)
        {
            List<tbl_trn_ipcase_corprationdetail> m_InPatientTemp = new List<tbl_trn_ipcase_corprationdetail>();
        ...
        private int put_InPatient_Update(ref put_IPCaseCorprationDetail_IP ipdc, ref put_IPCaseCorprationDetail_OP opdc)
        {
