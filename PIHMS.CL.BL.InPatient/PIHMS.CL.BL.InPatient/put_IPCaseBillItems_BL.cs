...
{
    class put_IPCaseBillItems_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseBillItems_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseBillItems(ref put_IPCaseBillItems_IP ipdc, ref put_IPCaseBillItems_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseBillItems_IP ipdc, ref put_IPCaseBillItems_OP opdc)
        {
            List<tbl_trn_ipcase_billitems> m_InPatientTemp = new List<tbl_trn_ipcase_billitems>();
        ...
        private int put_InPatient_Update(ref put_IPCaseBillItems_IP ipdc, ref put_IPCaseBillItems_OP opdc)
        {
