...
{
    class put_IPCaseList_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseList_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_IPCaseList(ref put_IPCaseList_IP ipdc, ref put_IPCaseList_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseList_IP ipdc, ref put_IPCaseList_OP opdc)
        {
            List<tbl_trn_ipcase> m_InPatientTemp = new List<tbl_trn_ipcase>();
        ...
        private int put_InPatient_Update(ref put_IPCaseList_IP ipdc, ref put_IPCaseList_OP opdc)
        {
