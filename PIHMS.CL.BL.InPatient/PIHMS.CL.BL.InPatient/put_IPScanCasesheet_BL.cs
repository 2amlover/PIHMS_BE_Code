...
{
    class put_IPScanCasesheet_BL : cls_BC_BusinessLogic
    {
        public put_IPScanCasesheet_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_IPScanCasesheet(ref put_IPScanCasesheet_IP ipdc, ref put_IPScanCasesheet_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPScanCasesheet_IP ipdc, ref put_IPScanCasesheet_OP opdc)
        {
            List<tbl_trn_ip_scan_casesheet> m_InPatientTemp = new List<tbl_trn_ip_scan_casesheet>();
        ...
        private int put_InPatient_Update(ref put_IPScanCasesheet_IP ipdc, ref put_IPScanCasesheet_OP opdc)
        {
