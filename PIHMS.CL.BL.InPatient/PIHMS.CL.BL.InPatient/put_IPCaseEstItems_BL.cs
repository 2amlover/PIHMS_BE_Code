...
{
    class put_IPCaseEstItems_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseEstItems_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseEstItems(ref put_IPCaseEstItems_IP ipdc, ref put_IPCaseEstItems_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseEstItems_IP ipdc, ref put_IPCaseEstItems_OP opdc)
        {
            List<tbl_rel_ipcase_est_items> m_InPatientTemp = new List<tbl_rel_ipcase_est_items>();
        ...
        private int put_InPatient_Update(ref put_IPCaseEstItems_IP ipdc, ref put_IPCaseEstItems_OP opdc)
        {
