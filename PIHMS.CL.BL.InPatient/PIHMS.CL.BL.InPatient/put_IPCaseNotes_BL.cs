...
{
    class put_IPCaseNotes_BL : cls_BC_BusinessLogic
    {
        public put_IPCaseNotes_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_IPCaseNotes(ref put_IPCaseNotes_IP ipdc, ref put_IPCaseNotes_OP opdc)
        {
        ...
        private int put_InPatient_Insert(ref put_IPCaseNotes_IP ipdc, ref put_IPCaseNotes_OP opdc)
        {
            List<tbl_trn_ipcase_notes> m_InPatientTemp = new List<tbl_trn_ipcase_notes>();
        ...
        private int put_InPatient_Update(ref put_IPCaseNotes_IP ipdc, ref put_IPCaseNotes_OP opdc)
        {
