...
{
    internal class get_IPCaseList
    {
        public async Task IPCaseList()
        {
            string url = "http://ganga.pihms.co.in/InPatient/get_IPCaseList";
            HttpClient client = new HttpClient();

            string jsonFilePath = "E:\\PIHMS\\PIHMS.Module.Code\\PIHMS.CL.BL.InPatient\\PIHMS.CL.BL.InPatient.TestApi\\JsonFile\\get_IPCaseList.json";
