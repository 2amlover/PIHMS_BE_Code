...
{
    internal class cls_Test_get_IPScanCasesheet_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPScanCasesheet_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPScanCasesheet_IP ip = new get_IPScanCasesheet_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPScanCasesheet_OP op = new get_IPScanCasesheet_OP();

            //RUN
            bl.get_IPScanCasesheet(ref ip, ref op);
