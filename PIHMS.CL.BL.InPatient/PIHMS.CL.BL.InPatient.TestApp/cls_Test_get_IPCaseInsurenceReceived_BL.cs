...
{
    internal class cls_Test_get_IPCaseInsurenceReceived_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseInsurenceReceived_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseInsurenceReceived_IP ip = new get_IPCaseInsurenceReceived_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseInsurenceReceived_OP op = new get_IPCaseInsurenceReceived_OP();

            //RUN
            bl.get_IPCaseInsurenceReceived(ref ip, ref op);
