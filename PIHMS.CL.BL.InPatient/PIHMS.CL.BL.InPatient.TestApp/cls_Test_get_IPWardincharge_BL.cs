...
{
    internal class cls_Test_get_IPWardincharge_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPWardincharge_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPWardincharge_IP ip = new get_IPWardincharge_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPWardincharge_OP op = new get_IPWardincharge_OP();

            //RUN
            bl.get_IPWardincharge(ref ip, ref op);
