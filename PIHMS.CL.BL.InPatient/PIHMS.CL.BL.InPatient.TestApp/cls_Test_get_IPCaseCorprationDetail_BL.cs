...
{
    internal class cls_Test_get_IPCaseCorprationDetail_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseCorprationDetail_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseCorprationDetail_IP ip = new get_IPCaseCorprationDetail_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseCorprationDetail_OP op = new get_IPCaseCorprationDetail_OP();

            //RUN
            bl.get_IPCaseCorprationDetail(ref ip, ref op);
