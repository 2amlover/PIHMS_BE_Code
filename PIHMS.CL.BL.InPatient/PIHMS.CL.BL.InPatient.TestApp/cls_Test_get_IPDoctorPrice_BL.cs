...
{
    internal class cls_Test_get_IPDoctorPrice_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPDoctorPrice_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPDoctorPrice_IP ip = new get_IPDoctorPrice_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPDoctorPrice_OP op = new get_IPDoctorPrice_OP();

            //RUN
            bl.get_IPDoctorPrice(ref ip, ref op);
