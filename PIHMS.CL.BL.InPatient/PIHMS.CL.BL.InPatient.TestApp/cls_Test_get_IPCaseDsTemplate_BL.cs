...
{
    internal class cls_Test_get_IPCaseDsTemplate_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseDsTemplate_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseDsTemplate_IP ip = new get_IPCaseDsTemplate_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseDsTemplate_OP op = new get_IPCaseDsTemplate_OP();

            //RUN
            bl.get_IPCaseDsTemplate(ref ip, ref op);
