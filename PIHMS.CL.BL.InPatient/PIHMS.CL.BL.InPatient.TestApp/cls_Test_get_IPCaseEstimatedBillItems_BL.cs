...
{
    internal class cls_Test_get_IPCaseEstimatedBillItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseEstimatedBillItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseEstimatedBillItems_IP ip = new get_IPCaseEstimatedBillItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";
            get_IPCaseEstimatedBillItems_OP op = new get_IPCaseEstimatedBillItems_OP();

            //RUN
            bl.get_IPCaseEstimatedBillItems(ref ip, ref op);
