...
{
    internal class cls_Test_get_IPCaseDiagnosisTagging_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseDiagnosisTagging_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseDiagnosisTagging_IP ip = new get_IPCaseDiagnosisTagging_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";
            get_IPCaseDiagnosisTagging_OP op = new get_IPCaseDiagnosisTagging_OP();

            //RUN
            bl.get_IPCaseDiagnosisTagging(ref ip, ref op);
