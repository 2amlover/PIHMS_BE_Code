...
{
    internal class cls_Test_get_IPCaseDsTemplateData_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseDsTemplateData_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseDsTemplateData_IP ip = new get_IPCaseDsTemplateData_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseDsTemplateData_OP op = new get_IPCaseDsTemplateData_OP();

            //RUN
            bl.get_IPCaseDsTemplateData(ref ip, ref op);
