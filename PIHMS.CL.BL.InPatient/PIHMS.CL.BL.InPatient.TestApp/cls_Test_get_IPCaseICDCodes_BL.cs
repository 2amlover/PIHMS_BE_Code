...
{
    internal class cls_Test_get_IPCaseICDCodes_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseICDCodes_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseICDCodes_IP ip = new get_IPCaseICDCodes_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseICDCodes_OP op = new get_IPCaseICDCodes_OP();

            //RUN
            bl.get_IPCaseICDCodes(ref ip, ref op);
