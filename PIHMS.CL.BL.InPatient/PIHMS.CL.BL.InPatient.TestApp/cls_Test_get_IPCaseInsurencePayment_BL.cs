...
{
    internal class cls_Test_get_IPCaseInsurencePayment_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseInsurencePayment_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseInsurencePayment_IP ip = new get_IPCaseInsurencePayment_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseInsurencePayment_OP op = new get_IPCaseInsurencePayment_OP();

            //RUN
            bl.get_IPCaseInsurencePayment(ref ip, ref op);
