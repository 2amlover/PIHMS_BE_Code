...
{
    internal class cls_Test_get_IPCaseMedications_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseMedications_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseMedications_IP ip = new get_IPCaseMedications_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseMedications_OP op = new get_IPCaseMedications_OP();

            //RUN
            bl.get_IPCaseMedications(ref ip, ref op);
