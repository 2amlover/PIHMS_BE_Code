...
{
    internal class cls_Test_get_IPCaseEstItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseEstItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseEstItems_IP ip = new get_IPCaseEstItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseEstItems_OP op = new get_IPCaseEstItems_OP();

            //RUN
            bl.get_IPCaseEstItems(ref ip, ref op);
