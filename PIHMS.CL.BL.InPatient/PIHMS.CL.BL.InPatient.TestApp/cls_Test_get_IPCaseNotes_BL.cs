...
{
    internal class cls_Test_get_IPCaseNotes_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseNotes_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseNotes_IP ip = new get_IPCaseNotes_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseNotes_OP op = new get_IPCaseNotes_OP();

            //RUN
            bl.get_IPCaseNotes(ref ip, ref op);
