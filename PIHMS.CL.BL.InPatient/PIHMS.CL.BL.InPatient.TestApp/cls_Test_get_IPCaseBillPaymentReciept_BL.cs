...
{
    internal class cls_Test_get_IPCaseBillPaymentReciept_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseBillPaymentReciept_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseBillPaymentReciept_IP ip = new get_IPCaseBillPaymentReciept_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseBillPaymentReciept_OP op = new get_IPCaseBillPaymentReciept_OP();

            //RUN
            bl.get_IPCaseBillPaymentReciept(ref ip, ref op);
