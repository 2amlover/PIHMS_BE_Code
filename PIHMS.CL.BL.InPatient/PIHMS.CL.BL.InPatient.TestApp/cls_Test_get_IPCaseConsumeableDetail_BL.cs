...
{
    internal class cls_Test_get_IPCaseConsumeableDetail_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseConsumeableDetail_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseConsumeableDetail_IP ip = new get_IPCaseConsumeableDetail_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseConsumeableDetail_OP op = new get_IPCaseConsumeableDetail_OP();

            //RUN
            bl.get_IPCaseConsumeableDetail(ref ip, ref op);
