...
{
    internal class cls_Test_get_IPCaseEstimatedBills_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseEstimatedBills_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseEstimatedBills_IP ip = new get_IPCaseEstimatedBills_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseEstimatedBills_OP op = new get_IPCaseEstimatedBills_OP();

            //RUN
            bl.get_IPCaseEstimatedBills(ref ip, ref op);
