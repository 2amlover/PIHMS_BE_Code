...
{
    internal class cls_Test_get_IPCaseDischargeSummary_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseDischargeSummary_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseDischargeSummary_IP ip = new get_IPCaseDischargeSummary_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseDischargeSummary_OP op = new get_IPCaseDischargeSummary_OP();

            //RUN
            bl.get_IPCaseDischargeSummary(ref ip, ref op);
