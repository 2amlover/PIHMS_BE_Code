...
{
    internal class cls_Test_get_IPCaseDsTitle_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseDsTitle_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseDsTitle_IP ip = new get_IPCaseDsTitle_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseDsTitle_OP op = new get_IPCaseDsTitle_OP();

            //RUN
            bl.get_IPCaseDsTitle(ref ip, ref op);
