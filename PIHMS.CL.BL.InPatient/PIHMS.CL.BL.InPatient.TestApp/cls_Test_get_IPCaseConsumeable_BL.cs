...
{
    internal class cls_Test_get_IPCaseConsumeable_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseConsumeable_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseConsumeable_IP ip = new get_IPCaseConsumeable_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseConsumeable_OP op = new get_IPCaseConsumeable_OP();

            //RUN
            bl.get_IPCaseConsumeable(ref ip, ref op);
