...
{
    internal class cls_Test_get_IPCaseBills_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseBills_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseBills_IP ip = new get_IPCaseBills_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseBills_OP op = new get_IPCaseBills_OP();

            //RUN
            bl.get_IPCaseBills(ref ip, ref op);
