...
{
    internal class cls_Test_get_IPCaseDoctors_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseDoctors_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseDoctors_IP ip = new get_IPCaseDoctors_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseDoctors_OP op = new get_IPCaseDoctors_OP();

            //RUN
            bl.get_IPCaseDoctors(ref ip, ref op);
