...
{
    internal class cls_Test_get_IPCaseSurgeryNotes_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseSurgeryNotes_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseSurgeryNotes_IP ip = new get_IPCaseSurgeryNotes_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseSurgeryNotes_OP op = new get_IPCaseSurgeryNotes_OP();

            //RUN
            bl.get_IPCaseSurgeryNotes(ref ip, ref op);
