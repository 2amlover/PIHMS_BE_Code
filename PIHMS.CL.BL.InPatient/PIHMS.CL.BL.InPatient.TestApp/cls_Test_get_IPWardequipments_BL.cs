...
{
    internal class cls_Test_get_IPWardequipments_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPWardequipments_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPWardequipments_IP ip = new get_IPWardequipments_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPWardequipments_OP op = new get_IPWardequipments_OP();

            //RUN
            bl.get_IPWardequipments(ref ip, ref op);
