...
{
    internal class cls_Test_get_IPCaseInsuranceDetail_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseInsuranceDetail_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseInsuranceDetail_IP ip = new get_IPCaseInsuranceDetail_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseInsuranceDetail_OP op = new get_IPCaseInsuranceDetail_OP();

            //RUN
            bl.get_IPCaseInsuranceDetail(ref ip, ref op);
