...
{
    internal class cls_Test_get_IPCaseBillPayments_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseBillPayments_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseBillPayments_IP ip = new get_IPCaseBillPayments_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseBillPayments_OP op = new get_IPCaseBillPayments_OP();

            //RUN
            bl.get_IPCaseBillPayments(ref ip, ref op);
