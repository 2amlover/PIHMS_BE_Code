...
{
    internal class cls_Test_get_IPCaseBillSummary_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseBillSummary_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseBillSummary_IP ip = new get_IPCaseBillSummary_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseBillSummary_OP op = new get_IPCaseBillSummary_OP();

            //RUN
            bl.get_IPCaseBillSummary(ref ip, ref op);
