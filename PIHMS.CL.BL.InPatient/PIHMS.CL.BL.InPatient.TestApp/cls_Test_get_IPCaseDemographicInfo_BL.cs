...
{
    internal class cls_Test_get_IPCaseDemographicInfo_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseDemographicInfo_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseDemographicInfo_IP ip = new get_IPCaseDemographicInfo_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseDemographicInfo_OP op = new get_IPCaseDemographicInfo_OP();

            //RUN
            bl.get_IPCaseDemographicInfo(ref ip, ref op);
