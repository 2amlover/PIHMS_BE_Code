...
{
    internal class cls_Test_get_IPCaseAdmittedFor_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseAdmittedFor_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseAdmittedFor_IP ip = new get_IPCaseAdmittedFor_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseAdmittedFor_OP op = new get_IPCaseAdmittedFor_OP();

            //RUN
            bl.get_IPCaseAdmittedFor(ref ip, ref op);
