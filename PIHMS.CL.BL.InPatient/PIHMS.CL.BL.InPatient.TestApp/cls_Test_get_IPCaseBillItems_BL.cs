...
{
    internal class cls_Test_get_IPCaseBillItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPCaseBillItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPCaseBillItems_IP ip = new get_IPCaseBillItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPCaseBillItems_OP op = new get_IPCaseBillItems_OP();

            //RUN
            bl.get_IPCaseBillItems(ref ip, ref op);
