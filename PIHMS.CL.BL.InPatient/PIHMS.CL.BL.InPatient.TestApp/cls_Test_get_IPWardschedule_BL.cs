...
{
    internal class cls_Test_get_IPWardschedule_BL
    {
        String m_DBConnStr;
        public cls_Test_get_IPWardschedule_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_IPWardschedule_IP ip = new get_IPWardschedule_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_IPWardschedule_OP op = new get_IPWardschedule_OP();

            //RUN
            bl.get_IPWardschedule(ref ip, ref op);
