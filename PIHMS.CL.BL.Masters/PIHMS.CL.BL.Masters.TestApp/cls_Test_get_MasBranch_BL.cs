...
{
    internal class cls_Test_get_MasBranch_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasBranch_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasBranch_IP ip = new get_MasBranch_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasBranch_OP op = new get_MasBranch_OP();

            //RUN
            bl.get_MasBranch(ref ip, ref op);
