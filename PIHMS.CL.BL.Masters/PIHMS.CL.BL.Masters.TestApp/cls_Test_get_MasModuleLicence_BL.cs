...
{
    internal class cls_Test_get_MasModuleLicence_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasModuleLicence_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasModuleLicence_IP ip = new get_MasModuleLicence_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasModuleLicence_OP op = new get_MasModuleLicence_OP();

            //RUN
            bl.get_MasModuleLicence(ref ip, ref op);
