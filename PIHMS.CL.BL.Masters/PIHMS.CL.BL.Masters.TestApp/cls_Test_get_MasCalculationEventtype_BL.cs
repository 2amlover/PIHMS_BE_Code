...
{
    internal class cls_Test_get_MasCalculationEventtype_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasCalculationEventtype_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasCalculationEventtype_IP ip = new get_MasCalculationEventtype_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasCalculationEventtype_OP op = new get_MasCalculationEventtype_OP();

            //RUN
            bl.get_MasCalculationEventtype(ref ip, ref op);
