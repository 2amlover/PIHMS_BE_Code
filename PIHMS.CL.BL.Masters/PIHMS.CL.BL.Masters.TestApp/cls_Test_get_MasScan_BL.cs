...
{
    internal class cls_Test_get_MasScan_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasScan_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasScan_IP ip = new get_MasScan_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasScan_OP op = new get_MasScan_OP();

            //RUN
            bl.get_MasScan(ref ip, ref op);
