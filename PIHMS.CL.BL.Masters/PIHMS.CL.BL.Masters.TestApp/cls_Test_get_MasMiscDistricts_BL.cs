...
{
    internal class cls_Test_get_MasMiscDistricts_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasMiscDistricts_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasMiscDistricts_IP ip = new get_MasMiscDistricts_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasMiscDistricts_OP op = new get_MasMiscDistricts_OP();

            //RUN
            bl.get_MasMiscDistricts(ref ip, ref op);
