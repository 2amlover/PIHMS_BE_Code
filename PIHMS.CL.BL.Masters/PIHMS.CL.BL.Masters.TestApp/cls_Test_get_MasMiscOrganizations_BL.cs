...
{
    internal class cls_Test_get_MasMiscOrganizations_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasMiscOrganizations_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasMiscOrganizations_IP ip = new get_MasMiscOrganizations_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasMiscOrganizations_OP op = new get_MasMiscOrganizations_OP();

            //RUN
            bl.get_MasMiscOrganizations(ref ip, ref op);
