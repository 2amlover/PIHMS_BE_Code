...
{
    internal class cls_Test_get_MasInsurance_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasInsurance_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasInsurance_IP ip = new get_MasInsurance_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasInsurance_OP op = new get_MasInsurance_OP();

            //RUN
            bl.get_MasInsurance(ref ip, ref op);
