...
{
    internal class cls_Test_get_MasCoreMedications_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasCoreMedications_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasCoreMedications_IP ip = new get_MasCoreMedications_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasCoreMedications_OP op = new get_MasCoreMedications_OP();

            //RUN
            bl.get_MasCoreMedications(ref ip, ref op);
