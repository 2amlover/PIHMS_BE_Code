...
{
    internal class cls_Test_get_MasMiscInsuranceproviders_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasMiscInsuranceproviders_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasMiscInsuranceproviders_IP ip = new get_MasMiscInsuranceproviders_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasMiscInsuranceproviders_OP op = new get_MasMiscInsuranceproviders_OP();

            //RUN
            bl.get_MasMiscInsuranceproviders(ref ip, ref op);
