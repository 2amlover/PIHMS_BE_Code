...
{
    internal class cls_Test_get_MasSurgery_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasSurgery_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasSurgery_IP ip = new get_MasSurgery_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasSurgery_OP op = new get_MasSurgery_OP();

            //RUN
            bl.get_MasSurgery(ref ip, ref op);
