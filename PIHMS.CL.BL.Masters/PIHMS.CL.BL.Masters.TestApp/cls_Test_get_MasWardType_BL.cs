...
{
    internal class cls_Test_get_MasWardType_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasWardType_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasWardType_IP ip = new get_MasWardType_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasWardType_OP op = new get_MasWardType_OP();

            //RUN
            bl.get_MasWardType(ref ip, ref op);
