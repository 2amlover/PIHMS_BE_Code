...
{
    internal class cls_Test_get_MasMiscCities_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasMiscCities_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasMiscCities_IP ip = new get_MasMiscCities_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasMiscCities_OP op = new get_MasMiscCities_OP();

            //RUN
            bl.get_MasMiscCities(ref ip, ref op);
