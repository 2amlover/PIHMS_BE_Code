...
{
    internal class cls_Test_get_MasHolidays_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasHolidays_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasHolidays_IP ip = new get_MasHolidays_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasHolidays_OP op = new get_MasHolidays_OP();

            //RUN
            bl.get_MasHolidays(ref ip, ref op);
