...
{
    internal class cls_Test_get_MasCalculationEventstatus_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasCalculationEventstatus_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasCalculationEventstatus_IP ip = new get_MasCalculationEventstatus_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasCalculationEventstatus_OP op = new get_MasCalculationEventstatus_OP();

            //RUN
            bl.get_MasCalculationEventstatus(ref ip, ref op);
