...
{
    internal class cls_Test_get_MasPayitems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasPayitems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasPayitems_IP ip = new get_MasPayitems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasPayitems_OP op = new get_MasPayitems_OP();

            //RUN
            bl.get_MasPayitems(ref ip, ref op);
