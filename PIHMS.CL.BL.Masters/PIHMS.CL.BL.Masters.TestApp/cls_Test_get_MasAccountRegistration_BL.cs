...
{
    internal class cls_Test_get_MasAccountRegistration_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasAccountRegistration_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasAccountRegistration_IP ip = new get_MasAccountRegistration_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasAccountRegistration_OP op = new get_MasAccountRegistration_OP();

            //RUN
            bl.get_MasAccountRegistration(ref ip, ref op);
