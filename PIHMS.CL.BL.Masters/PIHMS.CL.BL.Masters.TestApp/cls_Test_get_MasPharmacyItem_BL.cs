...
{
    internal class cls_Test_get_MasPharmacyItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasPharmacyItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasPharmacyItem_IP ip = new get_MasPharmacyItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasPharmacyItem_OP op = new get_MasPharmacyItem_OP();

            //RUN
            bl.get_MasPharmacyItem(ref ip, ref op);
