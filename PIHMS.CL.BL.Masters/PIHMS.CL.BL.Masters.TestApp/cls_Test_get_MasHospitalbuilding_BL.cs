...
{
    internal class cls_Test_get_MasHospitalbuilding_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasHospitalbuilding_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasHospitalbuilding_IP ip = new get_MasHospitalbuilding_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasHospitalbuilding_OP op = new get_MasHospitalbuilding_OP();

            //RUN
            bl.get_MasHospitalbuilding(ref ip, ref op);
