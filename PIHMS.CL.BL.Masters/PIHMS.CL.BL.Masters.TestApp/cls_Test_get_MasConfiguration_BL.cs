...
{
    internal class cls_Test_get_MasConfiguration_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasConfiguration_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasConfiguration_IP ip = new get_MasConfiguration_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasConfiguration_OP op = new get_MasConfiguration_OP();

            //RUN
            bl.get_MasConfiguration(ref ip, ref op);
