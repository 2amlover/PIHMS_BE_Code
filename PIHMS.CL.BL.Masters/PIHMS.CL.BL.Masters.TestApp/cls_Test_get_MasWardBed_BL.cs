...
{
    internal class cls_Test_get_MasWardBed_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasWardBed_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasWardBed_IP ip = new get_MasWardBed_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasWardBed_OP op = new get_MasWardBed_OP();

            //RUN
            bl.get_MasWardBed(ref ip, ref op);
