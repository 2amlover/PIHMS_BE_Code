...
{
    internal class cls_Test_get_MasApplicationFeature_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasApplicationFeature_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasApplicationFeature_IP ip = new get_MasApplicationFeature_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasApplicationFeature_OP op = new get_MasApplicationFeature_OP();

            //RUN
            bl.get_MasApplicationFeature(ref ip, ref op);
