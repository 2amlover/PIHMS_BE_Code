...
{
    internal class cls_Test_get_MasFloor_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasFloor_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasFloor_IP ip = new get_MasFloor_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasFloor_OP op = new get_MasFloor_OP();

            //RUN
            bl.get_MasFloor(ref ip, ref op);
