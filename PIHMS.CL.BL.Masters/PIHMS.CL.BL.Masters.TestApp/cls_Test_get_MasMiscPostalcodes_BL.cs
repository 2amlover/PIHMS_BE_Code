...
{
    internal class cls_Test_get_MasMiscPostalcodes_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasMiscPostalcodes_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasMiscPostalcodes_IP ip = new get_MasMiscPostalcodes_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasMiscPostalcodes_OP op = new get_MasMiscPostalcodes_OP();

            //RUN
            bl.get_MasMiscPostalcodes(ref ip, ref op);
