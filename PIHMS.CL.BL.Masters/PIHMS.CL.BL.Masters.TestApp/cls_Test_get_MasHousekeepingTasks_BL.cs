...
{
    internal class cls_Test_get_MasHousekeepingTasks_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasHousekeepingTasks_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasHousekeepingTasks_IP ip = new get_MasHousekeepingTasks_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasHousekeepingTasks_OP op = new get_MasHousekeepingTasks_OP();

            //RUN
            bl.get_MasHousekeepingTasks(ref ip, ref op);
