...
{
    internal class cls_Test_get_MasWard_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasWard_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasWard_IP ip = new get_MasWard_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasWard_OP op = new get_MasWard_OP();

            //RUN
            bl.get_MasWard(ref ip, ref op);
