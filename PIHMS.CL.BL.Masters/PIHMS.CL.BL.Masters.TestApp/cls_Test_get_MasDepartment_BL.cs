...
{
    internal class cls_Test_get_MasDepartment_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasDepartment_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasDepartment_IP ip = new get_MasDepartment_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasDepartment_OP op = new get_MasDepartment_OP();

            //RUN
            bl.get_MasDepartment(ref ip, ref op);
