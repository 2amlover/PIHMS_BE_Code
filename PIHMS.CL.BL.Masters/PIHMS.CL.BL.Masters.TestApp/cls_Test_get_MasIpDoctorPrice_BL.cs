...
{
    internal class cls_Test_get_MasIpDoctorPrice_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasIpDoctorPrice_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasIpDoctorPrice_IP ip = new get_MasIpDoctorPrice_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasIpDoctorPrice_OP op = new get_MasIpDoctorPrice_OP();

            //RUN
            bl.get_MasIpDoctorPrice(ref ip, ref op);
