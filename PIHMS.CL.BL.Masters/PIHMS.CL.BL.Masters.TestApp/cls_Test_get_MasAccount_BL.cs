...
{
    internal class cls_Test_get_MasAccount_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasAccount_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasAccount_IP ip = new get_MasAccount_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasAccount_OP op = new get_MasAccount_OP();

            //RUN
            bl.get_MasAccount(ref ip, ref op);
