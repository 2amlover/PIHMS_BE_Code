...
{
    internal class cls_Test_get_MasMiscCountries_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasMiscCountries_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasMiscCountries_IP ip = new get_MasMiscCountries_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasMiscCountries_OP op = new get_MasMiscCountries_OP();

            //RUN
            bl.get_MasMiscCountries(ref ip, ref op);
