...
{
    internal class cls_Test_get_MasModule_BL
    {
        String m_DBConnStr;
        public cls_Test_get_MasModule_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_MasModule_IP ip = new get_MasModule_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_MasModule_OP op = new get_MasModule_OP();

            //RUN
            bl.get_MasModule(ref ip, ref op);
