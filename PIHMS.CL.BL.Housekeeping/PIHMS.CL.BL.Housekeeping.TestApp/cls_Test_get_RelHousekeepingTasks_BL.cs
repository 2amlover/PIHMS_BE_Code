...
{
    internal class cls_Test_get_RelHousekeepingTasks_BL
    {
        String m_DBConnStr;
        public cls_Test_get_RelHousekeepingTasks_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_RelHousekeepingTasks_IP ip = new get_RelHousekeepingTasks_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_RelHousekeepingTasks_OP op = new get_RelHousekeepingTasks_OP();

            //RUN
            bl.get_RelHousekeepingTasks(ref ip, ref op);
