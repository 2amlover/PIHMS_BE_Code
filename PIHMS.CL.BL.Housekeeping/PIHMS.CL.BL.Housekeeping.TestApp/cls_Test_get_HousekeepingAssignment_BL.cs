...
{
    internal class cls_Test_get_HousekeepingAssignment_BL
    {
        String m_DBConnStr;
        public cls_Test_get_HousekeepingAssignment_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_HousekeepingAssignment_IP ip = new get_HousekeepingAssignment_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_HousekeepingAssignment_OP op = new get_HousekeepingAssignment_OP();

            //RUN
            bl.get_HousekeepingAssignment(ref ip, ref op);
