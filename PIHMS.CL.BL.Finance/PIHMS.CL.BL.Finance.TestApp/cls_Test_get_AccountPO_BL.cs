...
{
    internal class cls_Test_get_AccountPO_BL
    {
        String m_DBConnStr;
        public cls_Test_get_AccountPO_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_AccountPO_IP ip = new get_AccountPO_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_AccountPO_OP op = new get_AccountPO_OP();

            //RUN
            bl.get_AccountPO(ref ip, ref op);
