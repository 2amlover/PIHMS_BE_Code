...
{
    internal class cls_Test_get_AccountPayables_BL
    {
        String m_DBConnStr;
        public cls_Test_get_AccountPayables_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_AccountPayables_IP ip = new get_AccountPayables_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_AccountPayables_OP op = new get_AccountPayables_OP();

            //RUN
            bl.get_AccountPayables(ref ip, ref op);
