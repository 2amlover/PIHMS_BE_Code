...
{
    internal class cls_Test_get_RelPayables_BL
    {
        String m_DBConnStr;
        public cls_Test_get_RelPayables_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_RelPayables_IP ip = new get_RelPayables_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_RelPayables_OP op = new get_RelPayables_OP();

            //RUN
            bl.get_RelPayables(ref ip, ref op);
