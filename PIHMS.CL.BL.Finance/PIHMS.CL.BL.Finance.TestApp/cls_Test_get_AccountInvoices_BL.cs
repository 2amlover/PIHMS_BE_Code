...
{
    internal class cls_Test_get_AccountInvoices_BL
    {
        String m_DBConnStr;
        public cls_Test_get_AccountInvoices_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_AccountInvoices_IP ip = new get_AccountInvoices_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_AccountInvoices_OP op = new get_AccountInvoices_OP();

            //RUN
            bl.get_AccountInvoices(ref ip, ref op);
