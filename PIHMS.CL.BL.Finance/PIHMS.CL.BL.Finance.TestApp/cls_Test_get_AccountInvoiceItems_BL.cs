...
{
    internal class cls_Test_get_AccountInvoiceItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_AccountInvoiceItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_AccountInvoiceItems_IP ip = new get_AccountInvoiceItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_AccountInvoiceItems_OP op = new get_AccountInvoiceItems_OP();

            //RUN
            bl.get_AccountInvoiceItems(ref ip, ref op);
