...
{
    internal class cls_Test_get_PharmacyItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PharmacyItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PharmacyItems_IP ip = new get_PharmacyItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PharmacyItems_OP op = new get_PharmacyItems_OP();

            //RUN
            bl.get_PharmacyItems(ref ip, ref op);
