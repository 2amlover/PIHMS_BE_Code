...
{
    internal class cls_Test_get_PharmacyItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PharmacyItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PharmacyItem_IP ip = new get_PharmacyItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PharmacyItem_OP op = new get_PharmacyItem_OP();

            //RUN
            bl.get_PharmacyItem(ref ip, ref op);
