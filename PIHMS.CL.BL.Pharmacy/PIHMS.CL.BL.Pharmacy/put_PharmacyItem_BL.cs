...
{
    class put_PharmacyItem_BL : cls_BC_BusinessLogic
    {
        public put_PharmacyItem_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }


        public int put_PharmacyItem(ref put_PharmacyItem_IP ipdc, ref put_PharmacyItem_OP opdc)
        {
            ...
            if (ipdc.m_Pharmacy.ID > 0)
            {
                ...
                m_rc = put_PharmacyItem_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_PharmacyItem_Insert(ref ipdc, ref opdc);
        ...
        private int put_PharmacyItem_Insert(ref put_PharmacyItem_IP ipdc, ref put_PharmacyItem_OP opdc)
        {
            List<tbl_mas_pharmacy_item> m_PharmacyTemp = new List<tbl_mas_pharmacy_item>();
        ...
        private int put_PharmacyItem_Update(ref put_PharmacyItem_IP ipdc, ref put_PharmacyItem_OP opdc)
        {
