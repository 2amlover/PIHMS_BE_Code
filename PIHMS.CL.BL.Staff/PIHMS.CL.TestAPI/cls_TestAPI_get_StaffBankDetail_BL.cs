...
{
    public class cls_TestAPI_get_StaffBankDetail_BL
    {
        public string m_url = "";
        public string m_ipop_data_path = "";
        public string m_res_data_path = "";

        public cls_TestAPI_get_StaffBankDetail_BL()
        {
        ...
        //SC003 if my input satisfyl above all conditions with wrong input it says "No data found for ur inputs"
        ...
        public async Task SC003()
        {
            ...
            if (responseResult.Contains("\"ml_Staffbankdetail\":[]"))
            {
