...
{
    internal class cls_Test_get_StaffAttendance_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffAttendance_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        //    get_StaffAttendance_IP ip = new get_StaffAttendance_IP();
        //    ip.UserDBConnStr = m_DBConnStr;
        //    ip.m_Filter.m_Limit = "10";

        //    get_StaffAttendance_OP op = new get_StaffAttendance_OP();

        //    //RUN
        //    bl.get_StaffAttendance(ref ip, ref op);
