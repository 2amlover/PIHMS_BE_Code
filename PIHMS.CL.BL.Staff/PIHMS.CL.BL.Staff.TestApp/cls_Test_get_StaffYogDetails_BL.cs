...
{
    internal class cls_Test_get_StaffYogDetails_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffYogDetails_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffYogDetails_IP ip = new get_StaffYogDetails_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffYogDetails_OP op = new get_StaffYogDetails_OP();

            //RUN
            bl.get_StaffYogDetails(ref ip, ref op);
