...
{
    internal class cls_Test_get_Staff_BL
    {
        String m_DBConnStr;
        public cls_Test_get_Staff_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_Staff_IP ip = new get_Staff_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_Staff_OP op = new get_Staff_OP();

            //RUN
            bl.get_Staff(ref ip, ref op);
