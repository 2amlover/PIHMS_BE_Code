...
{
    internal class cls_Test_get_StaffReimbursements_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffReimbursements_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffReimbursements_IP ip = new get_StaffReimbursements_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffReimbursements_OP op = new get_StaffReimbursements_OP();

            //RUN
            bl.get_StaffReimbursements(ref ip, ref op);
