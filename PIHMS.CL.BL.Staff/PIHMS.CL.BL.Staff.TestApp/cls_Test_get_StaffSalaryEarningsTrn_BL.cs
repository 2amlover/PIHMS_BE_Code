...
{
    internal class cls_Test_get_StaffSalaryEarningsTrn_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffSalaryEarningsTrn_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffSalaryEarningsTrn_IP ip = new get_StaffSalaryEarningsTrn_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffSalaryEarningsTrn_OP op = new get_StaffSalaryEarningsTrn_OP();

            //RUN
            bl.get_StaffSalaryEarningsTrn(ref ip, ref op);
