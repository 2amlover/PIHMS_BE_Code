...
{
    internal class cls_Test_get_StaffBankDetails_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffBankDetails_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffBankDetails_IP ip = new get_StaffBankDetails_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffBankDetails_OP op = new get_StaffBankDetails_OP();

            //RUN
            bl.get_StaffBankDetails(ref ip, ref op);
