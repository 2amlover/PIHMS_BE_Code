...
{
    internal class cls_Test_get_StaffWorkItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffWorkItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffWorkItems_IP ip = new get_StaffWorkItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffWorkItems_OP op = new get_StaffWorkItems_OP();

            //RUN
            bl.get_StaffWorkItems(ref ip, ref op);
