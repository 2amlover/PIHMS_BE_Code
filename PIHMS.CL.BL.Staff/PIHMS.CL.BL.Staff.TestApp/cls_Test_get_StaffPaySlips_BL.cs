...
{
    internal class cls_Test_get_StaffPaySlips_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffPaySlips_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffPaySlips_IP ip = new get_StaffPaySlips_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffPaySlips_OP op = new get_StaffPaySlips_OP();

            //RUN
            bl.get_StaffPaySlips(ref ip, ref op);
