...
{
    internal class cls_Test_get_StaffAttendanceTrn_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffAttendanceTrn_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffAttendanceTrn_IP ip = new get_StaffAttendanceTrn_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffAttendanceTrn_OP op = new get_StaffAttendanceTrn_OP();

            //RUN
            bl.get_StaffAttendanceTrn(ref ip, ref op);
