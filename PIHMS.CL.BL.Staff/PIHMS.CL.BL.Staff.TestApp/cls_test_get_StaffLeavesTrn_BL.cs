...
{
    internal class cls_test_get_StaffLeavesTrn_BL
    {
        String m_DBConnStr;
        public cls_test_get_StaffLeavesTrn_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffLeavesTrn_IP ip = new get_StaffLeavesTrn_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffLeavesTrn_OP op = new get_StaffLeavesTrn_OP();

            //RUN
            bl.get_StaffLeavesTrn(ref ip, ref op);
