...
{
    internal class cls_Test_get_StaffMyDocuments_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffMyDocuments_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffMyDocuments_IP ip = new get_StaffMyDocuments_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffMyDocuments_OP op = new get_StaffMyDocuments_OP();

            //RUN
            bl.get_StaffMyDocuments(ref ip, ref op);
