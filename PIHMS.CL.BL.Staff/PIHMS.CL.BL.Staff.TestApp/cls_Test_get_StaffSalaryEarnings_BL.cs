...
{
    internal class cls_Test_get_StaffSalaryEarnings_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffSalaryEarnings_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffSalaryEarnings_IP ip = new get_StaffSalaryEarnings_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffSalaryEarnings_OP op = new get_StaffSalaryEarnings_OP();

            //RUN
            bl.get_StaffSalaryEarnings(ref ip, ref op);
