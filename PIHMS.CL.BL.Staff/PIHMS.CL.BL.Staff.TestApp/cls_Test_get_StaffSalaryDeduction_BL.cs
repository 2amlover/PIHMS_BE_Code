...
{
    internal class cls_Test_get_StaffSalaryDeduction_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffSalaryDeduction_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffSalaryDeduction_IP ip = new get_StaffSalaryDeduction_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffSalaryDeduction_OP op = new get_StaffSalaryDeduction_OP();

            //RUN
            bl.get_StaffSalaryDeduction(ref ip, ref op);
