...
{
    internal class cls_Test_get_StaffRoleAppFeature_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffRoleAppFeature_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffRoleAppFeature_IP ip = new get_StaffRoleAppFeature_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffRoleAppFeature_OP op = new get_StaffRoleAppFeature_OP();

            //RUN
            bl.get_StaffRoleAppFeature(ref ip, ref op);
