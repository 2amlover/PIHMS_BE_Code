...
{
    internal class cls_Test_get_StaffSalarySummary_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffSalarySummary_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffSalarySummary_IP ip = new get_StaffSalarySummary_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffSalarySummary_OP op = new get_StaffSalarySummary_OP();

            //RUN
            bl.get_StaffSalarySummary(ref ip, ref op);
