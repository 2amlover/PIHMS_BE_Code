...
{
    internal class cls_Test_get_StaffEmploymentTrn_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffEmploymentTrn_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffEmploymentTrn_IP ip = new get_StaffEmploymentTrn_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffEmploymentTrn_OP op = new get_StaffEmploymentTrn_OP();

            //RUN
            bl.get_StaffEmploymentTrn(ref ip, ref op);
