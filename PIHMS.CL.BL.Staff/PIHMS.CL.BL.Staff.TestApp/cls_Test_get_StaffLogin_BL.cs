...
{
    internal class cls_Test_get_StaffLogin_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffLogin_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffLogin_IP ip = new get_StaffLogin_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffLogin_OP op = new get_StaffLogin_OP();

            //RUN
            bl.get_StaffLogin(ref ip, ref op);
