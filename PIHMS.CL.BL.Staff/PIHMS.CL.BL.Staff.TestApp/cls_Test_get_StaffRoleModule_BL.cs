...
{
    internal class cls_Test_get_StaffRoleModule_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffRoleModule_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffRoleModule_IP ip = new get_StaffRoleModule_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffRoleModule_OP op = new get_StaffRoleModule_OP();

            //RUN
            bl.get_StaffRoleModule(ref ip, ref op);
