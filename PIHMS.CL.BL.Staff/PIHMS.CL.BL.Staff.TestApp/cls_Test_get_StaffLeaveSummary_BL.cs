...
{
    internal class cls_Test_get_StaffLeaveSummary_BL
    {
        String m_DBConnStr;
        public cls_Test_get_StaffLeaveSummary_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_StaffLeaveSummary_IP ip = new get_StaffLeaveSummary_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_StaffLeaveSummary_OP op = new get_StaffLeaveSummary_OP();

            //RUN
            bl.get_StaffLeaveSummary(ref ip, ref op);
