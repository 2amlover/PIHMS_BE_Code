...
{
    class put_InvItem_BL : cls_BC_BusinessLogic
    {
        public put_InvItem_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvItem(ref put_InvItem_IP ipdc, ref put_InvItem_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvItem_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvItem_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvItem_Insert(ref put_InvItem_IP ipdc, ref put_InvItem_OP opdc)
        {
            List<tbl_mas_inv_item> m_InventoryTemp = new List<tbl_mas_inv_item>();
        ...
        private int put_InvItem_Update(ref put_InvItem_IP ipdc, ref put_InvItem_OP opdc)
        {
