...
{
    class put_InvStores_BL : cls_BC_BusinessLogic
    {
        public put_InvStores_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_InvStores(ref put_InvStores_IP ipdc, ref put_InvStores_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvStores_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvStores_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvStores_Insert(ref put_InvStores_IP ipdc, ref put_InvStores_OP opdc)
        {
            List<tbl_mas_inv_stores> m_InventoryTemp = new List<tbl_mas_inv_stores>();
        ...
        private int put_InvStores_Update(ref put_InvStores_IP ipdc, ref put_InvStores_OP opdc)
        {
