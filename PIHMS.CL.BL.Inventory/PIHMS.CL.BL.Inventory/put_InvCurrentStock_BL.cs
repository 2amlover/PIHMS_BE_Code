...
{
    class put_InvCurrentStock_BL : cls_BC_BusinessLogic
    {
        public put_InvCurrentStock_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_InvCurrentStock(ref put_InvCurrentStock_IP ipdc, ref put_InvCurrentStock_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvCurrentStock_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvCurrentStock_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvCurrentStock_Insert(ref put_InvCurrentStock_IP ipdc, ref put_InvCurrentStock_OP opdc)
        {
            List<tbl_trn_inv_currentstock> m_InventoryTemp = new List<tbl_trn_inv_currentstock>();
        ...
        private int put_InvCurrentStock_Update(ref put_InvCurrentStock_IP ipdc, ref put_InvCurrentStock_OP opdc)
        {
