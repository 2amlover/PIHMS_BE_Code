...
{
    class put_InvIssueItem_BL : cls_BC_BusinessLogic
    {
        public put_InvIssueItem_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_InvIssueItem(ref put_InvIssueItem_IP ipdc, ref put_InvIssueItem_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvIssueItem_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvIssueItem_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvIssueItem_Insert(ref put_InvIssueItem_IP ipdc, ref put_InvIssueItem_OP opdc)
        {
            List<tbl_trn_inv_issue_item> m_InventoryTemp = new List<tbl_trn_inv_issue_item>();
        ...
        private int put_InvIssueItem_Update(ref put_InvIssueItem_IP ipdc, ref put_InvIssueItem_OP opdc)
        {
