...
{
    class put_InvPurchaseItem_BL : cls_BC_BusinessLogic
    {
        public put_InvPurchaseItem_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }
        ...
        public int put_InvPurchaseItem(ref put_InvPurchaseItem_IP ipdc, ref put_InvPurchaseItem_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvPurchaseItem_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvPurchaseItem_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvPurchaseItem_Insert(ref put_InvPurchaseItem_IP ipdc, ref put_InvPurchaseItem_OP opdc)
        {
            List<tbl_trn_inv_purchase_item> m_InventoryTemp = new List<tbl_trn_inv_purchase_item>();
        ...
        private int put_InvPurchaseItem_Update(ref put_InvPurchaseItem_IP ipdc, ref put_InvPurchaseItem_OP opdc)
        {
