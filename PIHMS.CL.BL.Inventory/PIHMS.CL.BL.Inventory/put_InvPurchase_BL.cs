...
{
    class put_InvPurchase_BL : cls_BC_BusinessLogic
    {
        public put_InvPurchase_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvPurchase(ref put_InvPurchase_IP ipdc, ref put_InvPurchase_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvPurchase_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvPurchase_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvPurchase_Insert(ref put_InvPurchase_IP ipdc, ref put_InvPurchase_OP opdc)
        {
            List<tbl_trn_inv_purchase> m_InventoryTemp = new List<tbl_trn_inv_purchase>();
        ...
        private int put_InvPurchase_Update(ref put_InvPurchase_IP ipdc, ref put_InvPurchase_OP opdc)
        {
