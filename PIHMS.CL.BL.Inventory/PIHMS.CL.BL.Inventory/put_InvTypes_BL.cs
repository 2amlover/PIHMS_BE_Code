...
{
    class put_InvTypes_BL : cls_BC_BusinessLogic
    {
        public put_InvTypes_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvTypes(ref put_InvTypes_IP ipdc, ref put_InvTypes_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvTypes_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvTypes_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvTypes_Insert(ref put_InvTypes_IP ipdc, ref put_InvTypes_OP opdc)
        {
            List<tbl_mas_inv_types> m_InventoryTemp = new List<tbl_mas_inv_types>();
        ...
        private int put_InvTypes_Update(ref put_InvTypes_IP ipdc, ref put_InvTypes_OP opdc)
        {
