...
{
    class put_InvStockBatch_BL : cls_BC_BusinessLogic
    {
        public put_InvStockBatch_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvStockBatch(ref put_InvStockBatch_IP ipdc, ref put_InvStockBatch_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvStockBatch_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvStockBatch_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvStockBatch_Insert(ref put_InvStockBatch_IP ipdc, ref put_InvStockBatch_OP opdc)
        {
            List<tbl_trn_inv_stockbatch> m_InventoryTemp = new List<tbl_trn_inv_stockbatch>();
        ...
        private int put_InvStockBatch_Update(ref put_InvStockBatch_IP ipdc, ref put_InvStockBatch_OP opdc)
        {
