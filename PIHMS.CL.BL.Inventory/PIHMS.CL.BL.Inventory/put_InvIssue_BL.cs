...
{
    class put_InvIssue_BL : cls_BC_BusinessLogic
    {
        public put_InvIssue_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_InvIssue(ref put_InvIssue_IP ipdc, ref put_InvIssue_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvIssue_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvIssue_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvIssue_Insert(ref put_InvIssue_IP ipdc, ref put_InvIssue_OP opdc)
        {
            List<tbl_trn_inv_issue> m_InventoryTemp = new List<tbl_trn_inv_issue>();
        ...
        private int put_InvIssue_Update(ref put_InvIssue_IP ipdc, ref put_InvIssue_OP opdc)
        {
