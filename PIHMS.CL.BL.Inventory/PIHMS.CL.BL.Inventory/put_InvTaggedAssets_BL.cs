...
{
    class put_InvTaggedAssets_BL : cls_BC_BusinessLogic
    {
        public put_InvTaggedAssets_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

       
        public int put_InvTaggedAssets(ref put_InvTaggedAssets_IP ipdc, ref put_InvTaggedAssets_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvTaggedAssets_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvTaggedAssets_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvTaggedAssets_Insert(ref put_InvTaggedAssets_IP ipdc, ref put_InvTaggedAssets_OP opdc)
        {
            List<tbl_trn_inv_taggedassets> m_InventoryTemp = new List<tbl_trn_inv_taggedassets>();
        ...
        private int put_InvTaggedAssets_Update(ref put_InvTaggedAssets_IP ipdc, ref put_InvTaggedAssets_OP opdc)
        {
