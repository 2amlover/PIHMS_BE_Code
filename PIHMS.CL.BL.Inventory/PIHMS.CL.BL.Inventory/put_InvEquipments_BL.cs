...
{
    class put_InvEquipments_BL : cls_BC_BusinessLogic
    {
        public put_InvEquipments_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvEquipments(ref put_InvEquipments_IP ipdc, ref put_InvEquipments_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvEquipments_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvEquipments_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvEquipments_Insert(ref put_InvEquipments_IP ipdc, ref put_InvEquipments_OP opdc)
        {
            List<tbl_mas_inv_equipments> m_InventoryTemp = new List<tbl_mas_inv_equipments>();
        ...
        private int put_InvEquipments_Update(ref put_InvEquipments_IP ipdc, ref put_InvEquipments_OP opdc)
        {
