...
{
    class put_InvItemIssue_BL : cls_BC_BusinessLogic
    {
        public put_InvItemIssue_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvItemIssue(ref put_InvItemIssue_IP ipdc, ref put_InvItemIssue_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvItemIssue_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvItemIssue_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvItemIssue_Insert(ref put_InvItemIssue_IP ipdc, ref put_InvItemIssue_OP opdc)
        {
            List<tbl_trn_inv_item_issue> m_InventoryTemp = new List<tbl_trn_inv_item_issue>();
        ...
        private int put_InvItemIssue_Update(ref put_InvItemIssue_IP ipdc, ref put_InvItemIssue_OP opdc)
        {
