...
{
    class put_InvItemPurchase_BL : cls_BC_BusinessLogic
    {
        public put_InvItemPurchase_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

      
        public int put_InvItemPurchase(ref put_InvItemPurchase_IP ipdc, ref put_InvItemPurchase_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvItemPurchase_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvItemPurchase_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvItemPurchase_Insert(ref put_InvItemPurchase_IP ipdc, ref put_InvItemPurchase_OP opdc)
        {
            List<tbl_trn_inv_item_purchase> m_InventoryTemp = new List<tbl_trn_inv_item_purchase>();
        ...
        private int put_InvItemPurchase_Update(ref put_InvItemPurchase_IP ipdc, ref put_InvItemPurchase_OP opdc)
        {
