...
{
    class put_InvUnit_BL : cls_BC_BusinessLogic
    {
        public put_InvUnit_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvUnit(ref put_InvUnit_IP ipdc, ref put_InvUnit_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvUnit_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvUnit_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvUnit_Insert(ref put_InvUnit_IP ipdc, ref put_InvUnit_OP opdc)
        {
            List<tbl_mas_inv_unit> m_InventoryTemp = new List<tbl_mas_inv_unit>();
        ...
        private int put_InvUnit_Update(ref put_InvUnit_IP ipdc, ref put_InvUnit_OP opdc)
        {
