...
{
    class put_InvDepartment_BL : cls_BC_BusinessLogic
    {
        public put_InvDepartment_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        public int put_InvDepartment(ref put_InvDepartment_IP ipdc, ref put_InvDepartment_OP opdc)
        {
            ...
            if (ipdc.m_Inventory.ID > 0)
            {
                ...
                m_rc = put_InvDepartment_Update(ref ipdc, ref opdc);
            ...
            else
            {
                ...
                m_rc = put_InvDepartment_Insert(ref ipdc, ref opdc);
        ...
        private int put_InvDepartment_Insert(ref put_InvDepartment_IP ipdc, ref put_InvDepartment_OP opdc)
        {
            List<tbl_mas_inv_department> m_InventoryTemp = new List<tbl_mas_inv_department>();
        ...
        private int put_InvDepartment_Update(ref put_InvDepartment_IP ipdc, ref put_InvDepartment_OP opdc)
        {
