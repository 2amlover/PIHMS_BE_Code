...
{
    internal class cls_Test_put_InvInventoryItems_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvInventoryItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvInventoryItems_IP ip = JsonSerializer.Deserialize<put_InvInventoryItems_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvInventoryItems_OP op = new put_InvInventoryItems_OP();

            //RUN
            bl.put_InvInventoryItems(ref ip, ref op);
            return Result;
        }
