...
{
    internal class cls_Test_get_InvEquipments_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvEquipments_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvEquipments_IP ip = new get_InvEquipments_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvEquipments_OP op = new get_InvEquipments_OP();

            //RUN
            bl.get_InvEquipments(ref ip, ref op);
