...
{
    internal class cls_Test_get_InvItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvItem_IP ip = new get_InvItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvItem_OP op = new get_InvItem_OP();

            //RUN
            bl.get_InvItem(ref ip, ref op);
