...
{
    internal class cls_Test_get_InvPurchaseItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvPurchaseItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvPurchaseItem_IP ip = new get_InvPurchaseItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvPurchaseItem_OP op = new get_InvPurchaseItem_OP();

            //RUN
            bl.get_InvPurchaseItem(ref ip, ref op);
