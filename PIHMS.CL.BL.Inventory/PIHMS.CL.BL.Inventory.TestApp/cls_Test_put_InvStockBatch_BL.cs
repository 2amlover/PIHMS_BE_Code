...
{
    internal class cls_Test_put_InvStockBatch_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvStockBatch_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvStockBatch_IP ip = JsonSerializer.Deserialize<put_InvStockBatch_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvStockBatch_OP op = new put_InvStockBatch_OP();

            //RUN
            bl.put_InvStockBatch(ref ip, ref op);
            return Result;
        }
