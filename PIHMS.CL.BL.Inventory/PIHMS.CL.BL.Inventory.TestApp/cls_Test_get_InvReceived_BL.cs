...
{
    internal class cls_Test_get_InvReceived_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvReceived_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvReceived_IP ip = new get_InvReceived_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvReceived_OP op = new get_InvReceived_OP();

            //RUN
            bl.get_InvReceived(ref ip, ref op);
