...
{
    internal class cls_Test_put_InvItemPurchase_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvItemPurchase_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvItemPurchase_IP ip = JsonSerializer.Deserialize<put_InvItemPurchase_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvItemPurchase_OP op = new put_InvItemPurchase_OP();

            //RUN
            bl.put_InvItemPurchase(ref ip, ref op);
            return Result;
        }
