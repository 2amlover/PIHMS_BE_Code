...
{
    internal class cls_Test_put_InvVendor_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvVendor_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvVendor_IP ip = JsonSerializer.Deserialize<put_InvVendor_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvVendor_OP op = new put_InvVendor_OP();

            //RUN
            bl.put_InvVendor(ref ip, ref op);
            return Result;
        }
