...
{
    internal class cls_Test_get_InvIssued_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvIssued_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvIssued_IP ip = new get_InvIssued_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvIssued_OP op = new get_InvIssued_OP();

            //RUN
            bl.get_InvIssued(ref ip, ref op);
