...
{
    internal class cls_Test_get_InvStorageForms_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvStorageForms_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvStorageForms_IP ip = new get_InvStorageForms_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvStorageForms_OP op = new get_InvStorageForms_OP();

            //RUN
            bl.get_InvStorageForms(ref ip, ref op);
