...
{
    internal class cls_Test_get_InvIssue_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvIssue_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvIssue_IP ip = new get_InvIssue_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvIssue_OP op = new get_InvIssue_OP();

            //RUN
            bl.get_InvIssue(ref ip, ref op);
