...
{
    internal class cls_Test_put_InvIssued_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvIssued_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvIssued_IP ip = JsonSerializer.Deserialize<put_InvIssued_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvIssued_OP op = new put_InvIssued_OP();

            //RUN
            bl.put_InvIssued(ref ip, ref op);
            return Result;
        }
