...
{
    internal class cls_Test_get_InvIssueItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvIssueItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvIssueItem_IP ip = new get_InvIssueItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvIssueItem_OP op = new get_InvIssueItem_OP();

            //RUN
            bl.get_InvIssueItem(ref ip, ref op);
