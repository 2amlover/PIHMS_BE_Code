...
{
    internal class cls_Test_get_InvInventoryItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvInventoryItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvInventoryItems_IP ip = new get_InvInventoryItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvInventoryItems_OP op = new get_InvInventoryItems_OP();

            //RUN
            bl.get_InvInventoryItems(ref ip, ref op);
