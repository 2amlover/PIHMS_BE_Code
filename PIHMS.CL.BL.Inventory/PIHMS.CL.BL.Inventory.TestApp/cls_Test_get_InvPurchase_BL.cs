...
{
    internal class cls_Test_get_InvPurchase_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvPurchase_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvPurchase_IP ip = new get_InvPurchase_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvPurchase_OP op = new get_InvPurchase_OP();

            //RUN
            bl.get_InvPurchase(ref ip, ref op);
