...
{
    internal class cls_Test_get_InvTaggedAssets_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvTaggedAssets_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvTaggedAssets_IP ip = new get_InvTaggedAssets_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvTaggedAssets_OP op = new get_InvTaggedAssets_OP();

            //RUN
            bl.get_InvTaggedAssets(ref ip, ref op);
