...
{
    internal class cls_Test_get_InvDepartment_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvDepartment_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvDepartment_IP ip = new get_InvDepartment_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvDepartment_OP op = new get_InvDepartment_OP();

            //RUN
            bl.get_InvDepartment(ref ip, ref op);
