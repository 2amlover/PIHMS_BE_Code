...
{
    internal class cls_Test_put_InvPurchase_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvPurchase_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvPurchase_IP ip = JsonSerializer.Deserialize<put_InvPurchase_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvPurchase_OP op = new put_InvPurchase_OP();

            //RUN
            bl.put_InvPurchase(ref ip, ref op);
            return Result;
        }
