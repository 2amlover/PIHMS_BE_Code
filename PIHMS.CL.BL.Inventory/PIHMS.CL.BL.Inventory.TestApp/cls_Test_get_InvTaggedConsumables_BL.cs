...
{
    internal class cls_Test_get_InvTaggedConsumables_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvTaggedConsumables_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvTaggedConsumables_IP ip = new get_InvTaggedConsumables_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvTaggedConsumables_OP op = new get_InvTaggedConsumables_OP();

            //RUN
            bl.get_InvTaggedConsumables(ref ip, ref op);
