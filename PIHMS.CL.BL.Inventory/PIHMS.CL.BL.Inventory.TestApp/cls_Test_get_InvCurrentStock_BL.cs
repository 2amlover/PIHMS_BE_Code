...
{
    internal class cls_Test_get_InvCurrentStock_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvCurrentStock_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvCurrentStock_IP ip = new get_InvCurrentStock_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvCurrentStock_OP op = new get_InvCurrentStock_OP();

            //RUN
            bl.get_InvCurrentStock(ref ip, ref op);
