...
{
    internal class cls_Test_put_InvItemIssue_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvItemIssue_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvItemIssue_IP ip = JsonSerializer.Deserialize<put_InvItemIssue_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvItemIssue_OP op = new put_InvItemIssue_OP();

            //RUN
            bl.put_InvItemIssue(ref ip, ref op);
            return Result;
        }
