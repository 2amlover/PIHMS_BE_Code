...
{
    internal class cls_Test_get_InvEquipmentTypes_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvEquipmentTypes_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvEquipmentTypes_IP ip = new get_InvEquipmentTypes_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvEquipmentTypes_OP op = new get_InvEquipmentTypes_OP();

            //RUN
            bl.get_InvEquipmentTypes(ref ip, ref op);
