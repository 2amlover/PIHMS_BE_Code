...
{
    internal class cls_Test_get_InvUnit_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvUnit_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvUnit_IP ip = new get_InvUnit_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvUnit_OP op = new get_InvUnit_OP();

            //RUN
            bl.get_InvUnit(ref ip, ref op);
