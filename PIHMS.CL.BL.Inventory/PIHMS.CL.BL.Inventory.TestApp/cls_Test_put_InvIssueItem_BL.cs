...
{
    internal class cls_Test_put_InvIssueItem_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvIssueItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvIssueItem_IP ip = JsonSerializer.Deserialize<put_InvIssueItem_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvIssueItem_OP op = new put_InvIssueItem_OP();

            //RUN
            bl.put_InvIssueItem(ref ip, ref op);
            return Result;
        }
