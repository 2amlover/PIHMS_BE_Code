...
{
    internal class cls_Test_get_InvItemVendor_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvItemVendor_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvItemVendor_IP ip = new get_InvItemVendor_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvItemVendor_OP op = new get_InvItemVendor_OP();

            //RUN
            bl.get_InvItemVendor(ref ip, ref op);
