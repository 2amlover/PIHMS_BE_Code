...
{
    internal class cls_Test_get_InvTypes_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvTypes_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvTypes_IP ip = new get_InvTypes_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvTypes_OP op = new get_InvTypes_OP();

            //RUN
            bl.get_InvTypes(ref ip, ref op);
