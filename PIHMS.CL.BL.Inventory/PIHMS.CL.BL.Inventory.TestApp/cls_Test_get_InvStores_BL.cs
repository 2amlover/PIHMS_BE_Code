...
{
    internal class cls_Test_get_InvStores_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvStores_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvStores_IP ip = new get_InvStores_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvStores_OP op = new get_InvStores_OP();

            //RUN
            bl.get_InvStores(ref ip, ref op);
