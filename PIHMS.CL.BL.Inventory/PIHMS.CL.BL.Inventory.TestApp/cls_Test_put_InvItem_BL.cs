...
{
    internal class cls_Test_put_InvItem_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvItem_IP ip = JsonSerializer.Deserialize<put_InvItem_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvItem_OP op = new put_InvItem_OP();

            //RUN
            bl.put_InvItem(ref ip, ref op);
            return Result;
        }
