...
{
    internal class cls_Test_put_InvEquipments_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvEquipments_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvEquipments_IP ip = JsonSerializer.Deserialize<put_InvEquipments_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvEquipments_OP op = new put_InvEquipments_OP();

            //RUN
            bl.put_InvEquipments(ref ip, ref op);
            return Result;
        }
