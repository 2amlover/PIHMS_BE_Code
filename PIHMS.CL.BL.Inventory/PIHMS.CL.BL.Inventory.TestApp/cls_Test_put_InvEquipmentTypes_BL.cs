...
{
    internal class cls_Test_put_InvEquipmentTypes_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvEquipmentTypes_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvEquipmentTypes_IP ip = JsonSerializer.Deserialize<put_InvEquipmentTypes_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvEquipmentTypes_OP op = new put_InvEquipmentTypes_OP();

            //RUN
            bl.put_InvEquipmentTypes(ref ip, ref op);
            return Result;
        }
