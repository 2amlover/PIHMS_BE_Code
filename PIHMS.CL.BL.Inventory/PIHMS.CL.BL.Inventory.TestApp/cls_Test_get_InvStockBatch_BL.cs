...
{
    internal class cls_Test_get_InvStockBatch_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvStockBatch_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvStockBatch_IP ip = new get_InvStockBatch_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvStockBatch_OP op = new get_InvStockBatch_OP();

            //RUN
            bl.get_InvStockBatch(ref ip, ref op);
