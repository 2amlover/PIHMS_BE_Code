...
{
    internal class cls_Test_get_InvVendor_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvVendor_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvVendor_IP ip = new get_InvVendor_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvVendor_OP op = new get_InvVendor_OP();

            //RUN
            bl.get_InvVendor(ref ip, ref op);
