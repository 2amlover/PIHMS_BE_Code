...
{
    internal class cls_Test_put_InvUnit_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvUnit_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvUnit_IP ip = JsonSerializer.Deserialize<put_InvUnit_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvUnit_OP op = new put_InvUnit_OP();

            //RUN
            bl.put_InvUnit(ref ip, ref op);
            return Result;
        }
