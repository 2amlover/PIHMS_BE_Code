...
{
    internal class cls_Test_get_InvItemIssue_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvItemIssue_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvItemIssue_IP ip = new get_InvItemIssue_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvItemIssue_OP op = new get_InvItemIssue_OP();

            //RUN
            bl.get_InvItemIssue(ref ip, ref op);
