...
{
    internal class cls_Test_put_InvStores_BL
    {
        String m_DBConnStr;
        public cls_Test_put_InvStores_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001(String DataFile)
        {
            ...
            put_InvStores_IP ip = JsonSerializer.Deserialize<put_InvStores_IP>(jsonData);
            ip.UserDBConnStr = m_DBConnStr;
            put_InvStores_OP op = new put_InvStores_OP();

            //RUN
            bl.put_InvStores(ref ip, ref op);
            return Result;
        }
