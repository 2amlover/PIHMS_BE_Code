...
{
    internal class cls_Test_get_InvItemPurchase_BL
    {
        String m_DBConnStr;
        public cls_Test_get_InvItemPurchase_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_InvItemPurchase_IP ip = new get_InvItemPurchase_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_InvItemPurchase_OP op = new get_InvItemPurchase_OP();

            //RUN
            bl.get_InvItemPurchase(ref ip, ref op);
