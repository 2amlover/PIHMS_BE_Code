...
{
    internal class cls_Test_get_CalEvent_BL
    {
        String m_DBConnStr;
        public cls_Test_get_CalEvent_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_CalEvent_IP ip = new get_CalEvent_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_CalEvent_OP op = new get_CalEvent_OP();

            //RUN
            bl.get_CalEvent(ref ip, ref op);
