...
{
    internal class cls_Test_get_CalRepeatTimings_BL
    {
        String m_DBConnStr;
        public cls_Test_get_CalRepeatTimings_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_CalRepeatTimings_IP ip = new get_CalRepeatTimings_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_CalRepeatTimings_OP op = new get_CalRepeatTimings_OP();

            //RUN
            bl.get_CalRepeatTimings(ref ip, ref op);
