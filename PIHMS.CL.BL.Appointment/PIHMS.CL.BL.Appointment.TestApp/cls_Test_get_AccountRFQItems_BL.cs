...
{
    internal class cls_Test_get_AccountRFQItems_BL
    {
        String m_DBConnStr;
        public cls_Test_get_AccountRFQItems_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_AccountRFQItems_IP ip = new get_AccountRFQItems_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_AccountRFQItems_OP op = new get_AccountRFQItems_OP();

            //RUN
            bl.get_AccountRFQItems(ref ip, ref op);
