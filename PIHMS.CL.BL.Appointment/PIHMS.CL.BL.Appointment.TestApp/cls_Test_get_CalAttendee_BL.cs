...
{
    internal class cls_Test_get_CalAttendee_BL
    {
        String m_DBConnStr;
        public cls_Test_get_CalAttendee_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_CalAttendee_IP ip = new get_CalAttendee_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_CalAttendee_OP op = new get_CalAttendee_OP();

            //RUN
            bl.get_CalAttendee(ref ip, ref op);
