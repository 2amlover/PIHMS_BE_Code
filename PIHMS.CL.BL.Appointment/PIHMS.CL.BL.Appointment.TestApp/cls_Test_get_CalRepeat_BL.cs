...
{
    internal class cls_Test_get_CalRepeat_BL
    {
        String m_DBConnStr;
        public cls_Test_get_CalRepeat_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_CalRepeat_IP ip = new get_CalRepeat_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_CalRepeat_OP op = new get_CalRepeat_OP();

            //RUN
            bl.get_CalRepeat(ref ip, ref op);
