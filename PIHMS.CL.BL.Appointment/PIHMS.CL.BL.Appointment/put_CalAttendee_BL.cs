...
{
    class put_CalAttendee_BL : cls_BC_BusinessLogic
    {
        public put_CalAttendee_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        
        public int put_CalAttendee(ref put_CalAttendee_IP ipdc, ref put_CalAttendee_OP opdc)
        {
        ...
        private int put_Appointment_Insert(ref put_CalAttendee_IP ipdc, ref put_CalAttendee_OP opdc)
        {
            List<tbl_trn_cal_attendee> ml_AppointmentTemp = new List<tbl_trn_cal_attendee>();
        ...
        private int put_Appointment_Update(ref put_CalAttendee_IP ipdc, ref put_CalAttendee_OP opdc)
        {
