...
{
    class put_CalRepeat_BL : cls_BC_BusinessLogic
    {
        public put_CalRepeat_BL(ref cls_Util_DBAccess dbc)
        {
            m_dbc = dbc;
        }

        
        public int put_CalRepeat(ref put_CalRepeat_IP ipdc, ref put_CalRepeat_OP opdc)
        {
        ...
        private int put_Appointment_Insert(ref put_CalRepeat_IP ipdc, ref put_CalRepeat_OP opdc)
        {
            List<tbl_trn_cal_repeat> ml_AppointmentTemp = new List<tbl_trn_cal_repeat>();
        ...
        private int put_Appointment_Update(ref put_CalRepeat_IP ipdc, ref put_CalRepeat_OP opdc)
        {
