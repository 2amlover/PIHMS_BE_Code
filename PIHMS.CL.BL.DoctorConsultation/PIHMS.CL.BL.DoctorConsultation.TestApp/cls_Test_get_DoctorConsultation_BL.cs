...
{
    internal class cls_Test_get_DoctorConsultation_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DoctorConsultation_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DoctorConsultation_IP ip = new get_DoctorConsultation_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DoctorConsultation_OP op = new get_DoctorConsultation_OP();

            //RUN
            bl.get_DoctorConsultation(ref ip, ref op);
