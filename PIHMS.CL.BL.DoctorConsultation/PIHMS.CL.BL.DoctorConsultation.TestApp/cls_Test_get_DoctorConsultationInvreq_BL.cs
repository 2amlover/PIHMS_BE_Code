...
{
    internal class cls_Test_get_DoctorConsultationInvreq_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DoctorConsultationInvreq_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DoctorConsultationInvreq_IP ip = new get_DoctorConsultationInvreq_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DoctorConsultationInvreq_OP op = new get_DoctorConsultationInvreq_OP();

            //RUN
            bl.get_DoctorConsultationInvreq(ref ip, ref op);
