...
{
    internal class cls_Test_get_DoctorConsultationInvreqItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DoctorConsultationInvreqItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DoctorConsultationInvreqItem_IP ip = new get_DoctorConsultationInvreqItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DoctorConsultationInvreqItem_OP op = new get_DoctorConsultationInvreqItem_OP();

            //RUN
            bl.get_DoctorConsultationInvreqItem(ref ip, ref op);
