...
{
    internal class cls_Test_get_OPConsultAppointment_BL
    {
        String m_DBConnStr;
        public cls_Test_get_OPConsultAppointment_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_OPConsultAppointment_IP ip = new get_OPConsultAppointment_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_OPConsultAppointment_OP op = new get_OPConsultAppointment_OP();

            //RUN
            bl.get_OPConsultAppointment(ref ip, ref op);
