...
{
    internal class cls_Test_get_DoctorConsultationDocument_BL
    {
        String m_DBConnStr;
        public cls_Test_get_DoctorConsultationDocument_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_DoctorConsultationDocument_IP ip = new get_DoctorConsultationDocument_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_DoctorConsultationDocument_OP op = new get_DoctorConsultationDocument_OP();

            //RUN
            bl.get_DoctorConsultationDocument(ref ip, ref op);
