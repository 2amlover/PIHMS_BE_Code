...
{
    internal class cls_Test_get_PharmacyOpconsultItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PharmacyOpconsultItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PharmacyOpconsultItem_IP ip = new get_PharmacyOpconsultItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PharmacyOpconsultItem_OP op = new get_PharmacyOpconsultItem_OP();

            //RUN
            bl.get_PharmacyOpconsultItem(ref ip, ref op);
