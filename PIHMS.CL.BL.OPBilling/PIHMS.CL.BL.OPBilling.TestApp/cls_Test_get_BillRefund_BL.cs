...
{
    internal class cls_Test_get_BillRefund_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillRefund_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillRefund_IP ip = new get_BillRefund_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillRefund_OP op = new get_BillRefund_OP();

            //RUN
            bl.get_BillRefund(ref ip, ref op);
