...
{
        internal class cls_Test_get_BillDomain_BL
        {
            String m_DBConnStr;
            public cls_Test_get_BillDomain_BL(String dbCon)
            {
                m_DBConnStr = dbCon;
            }
            ...
            public String SC_001()
            {
                ...
                get_BillDomain_IP ip = new get_BillDomain_IP();
                ip.UserDBConnStr = m_DBConnStr;
                ip.m_Filter.m_Limit = "10";

                get_BillDomain_OP op = new get_BillDomain_OP();

                //RUN
                bl.get_BillDomain(ref ip, ref op);
