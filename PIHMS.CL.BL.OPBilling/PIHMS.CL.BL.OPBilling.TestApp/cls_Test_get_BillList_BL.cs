...
{
    internal class cls_Test_get_BillList_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillList_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillList_IP ip = new get_BillList_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillList_OP op = new get_BillList_OP();

            //RUN
            bl.get_BillList(ref ip, ref op);
