...
{
    internal class cls_Test_get_BillItemMas_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillItemMas_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillItemMas_IP ip = new get_BillItemMas_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillItemMas_OP op = new get_BillItemMas_OP();

            //RUN
            bl.get_BillItemMas(ref ip, ref op);
