...
{
    internal class cls_Test_get_BillSession_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillSession_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillSession_IP ip = new get_BillSession_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillSession_OP op = new get_BillSession_OP();

            //RUN
            bl.get_BillSession(ref ip, ref op);
