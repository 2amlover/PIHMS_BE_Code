...
{
    internal class cls_Test_get_PackageBillPayment_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PackageBillPayment_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PackageBillPayment_IP ip = new get_PackageBillPayment_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PackageBillPayment_OP op = new get_PackageBillPayment_OP();

            //RUN
            bl.get_PackageBillPayment(ref ip, ref op);
