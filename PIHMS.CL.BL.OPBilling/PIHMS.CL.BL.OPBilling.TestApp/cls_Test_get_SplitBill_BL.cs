...
{
    internal class cls_Test_get_SplitBill_BL
    {
        String m_DBConnStr;
        public cls_Test_get_SplitBill_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_SplitBill_IP ip = new get_SplitBill_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_SplitBill_OP op = new get_SplitBill_OP();

            //RUN
            bl.get_SplitBill(ref ip, ref op);
