...
{
    internal class cls_Test_get_BillDomainItem_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillDomainItem_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillDomainItem_IP ip = new get_BillDomainItem_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillDomainItem_OP op = new get_BillDomainItem_OP();

            //RUN
            bl.get_BillDomainItem(ref ip, ref op);
