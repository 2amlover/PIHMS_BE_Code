...
{
    internal class cls_Test_get_BillItemPrice_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillItemPrice_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillItemPrice_IP ip = new get_BillItemPrice_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillItemPrice_OP op = new get_BillItemPrice_OP();

            //RUN
            bl.get_BillItemPrice(ref ip, ref op);
