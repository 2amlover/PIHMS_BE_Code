...
{
    internal class cls_Test_get_BillItemTrn_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillItemTrn_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillItemTrn_IP ip = new get_BillItemTrn_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillItemTrn_OP op = new get_BillItemTrn_OP();

            //RUN
            bl.get_BillItemTrn(ref ip, ref op);
