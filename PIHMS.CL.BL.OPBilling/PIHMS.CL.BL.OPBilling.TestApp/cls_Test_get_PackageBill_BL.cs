...
{
    internal class cls_Test_get_PackageBill_BL
    {
        String m_DBConnStr;
        public cls_Test_get_PackageBill_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_PackageBill_IP ip = new get_PackageBill_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_PackageBill_OP op = new get_PackageBill_OP();

            //RUN
            bl.get_PackageBill(ref ip, ref op);
