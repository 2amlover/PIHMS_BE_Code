...
{
    internal class cls_Test_get_BillPayment_BL
    {
        String m_DBConnStr;
        public cls_Test_get_BillPayment_BL(String dbCon)
        {
            m_DBConnStr = dbCon;
        }
        ...
        public String SC_001()
        {
            ...
            get_BillPayment_IP ip = new get_BillPayment_IP();
            ip.UserDBConnStr = m_DBConnStr;
            ip.m_Filter.m_Limit = "10";

            get_BillPayment_OP op = new get_BillPayment_OP();

            //RUN
            bl.get_BillPayment(ref ip, ref op);
